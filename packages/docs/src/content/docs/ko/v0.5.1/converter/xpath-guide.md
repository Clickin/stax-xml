...
slug: ko/v0.5.1/converter/xpath-guide
---
...
- [변환](/stax-xml/ko/v0.5.1/converter/transformations)에서 후처리 학습
- [스키마 타입](/stax-xml/ko/v0.5.1/converter/schemas)에서 유효성 검사 옵션 확인
- [예제](/stax-xml/ko/v0.5.1/converter/examples)에서 실전 XPath 사용 탐색
