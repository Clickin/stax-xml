...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/converter/getting-started.png
slug: ko/v0.5.1/converter/getting-started
---
...
- [핵심 개념](/stax-xml/ko/v0.5.1/converter/core-concepts)에서 스키마 기본 사항 학습
- [스키마 타입](/stax-xml/ko/v0.5.1/converter/schemas)에서 상세한 API 레퍼런스 탐색
- [XPath](/stax-xml/ko/v0.5.1/converter/xpath-guide)로 요소 선택 마스터
- [예제](/stax-xml/ko/v0.5.1/converter/examples)에서 실전 사용 패턴 확인
