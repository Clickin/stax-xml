...
- `pnpm --filter benchmark run release:expanded`: 생성된 runtime matrix,
  4 GiB `StreamReaderSync` index-first benchmark, converter compiled
  batch-plan benchmark, 1 GiB writer benchmark 결과를 다시 생성.
...
<ReleaseBenchmarkTable kind="runtime" locale="ko" version="v1.0.0-rc3" />
...
<ReleaseBenchmarkTable kind="stream4gib" locale="ko" version="v1.0.0-rc3" />
...
<ReleaseBenchmarkTable kind="converter" locale="ko" version="v1.0.0-rc3" />
