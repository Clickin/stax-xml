...
<ReleaseBenchmarkTable kind="runtime" locale="ko" />
...
<ReleaseBenchmarkTable kind="stream4gib" locale="ko" />
...
수동 기준값은 선택된 object layout을 converter 결과와 맞추지만, schema wrapper가
아닌 fixture 전용 하한값입니다. Converter 행은 같은 byte fixture를 다음 경로로
파싱합니다.
...
<ReleaseBenchmarkTable kind="converter" locale="ko" />
