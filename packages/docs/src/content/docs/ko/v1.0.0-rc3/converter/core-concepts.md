...
slug: ko/v1.0.0-rc3/converter/core-concepts
---
...
- [스키마 타입](/stax-xml/ko/converter/schemas)에서 상세 API 레퍼런스 탐색
- [XPath 패턴](/stax-xml/ko/converter/xpath-guide)으로 요소 선택 학습
- [변환](/stax-xml/ko/converter/transformations)에서 데이터 처리 확인
