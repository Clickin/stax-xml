...
slug: ko/v0.5.2/converter/examples
---
...
- [스키마 타입](/stax-xml/ko/v0.5.2/converter/schemas)에서 사용 가능한 모든 메서드 검토
- [변환](/stax-xml/ko/v0.5.2/converter/transformations)에서 데이터 처리 학습
