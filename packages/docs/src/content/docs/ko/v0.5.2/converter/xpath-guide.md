...
slug: ko/v0.5.2/converter/xpath-guide
---
...
- [변환](/stax-xml/ko/v0.5.2/converter/transformations)에서 후처리 학습
- [스키마 타입](/stax-xml/ko/v0.5.2/converter/schemas)에서 유효성 검사 옵션 확인
- [예제](/stax-xml/ko/v0.5.2/converter/examples)에서 실전 XPath 사용 탐색
- [XML 쓰기](/stax-xml/ko/v0.5.2/converter/writing-xml)에서 직렬화 확인
