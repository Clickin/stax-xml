...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/ko/api-guides/staxxml-writer.png
slug: ko/v0.7.0/api-guides/staxxml-writer
---
...
대용량 파일이나 대용량 문서를 최대 처리량으로 생성해야 한다면 [`StaxXmlWriterSyncSink`](/stax-xml/ko/v0.7.0/api-guides/staxxml-writer-sync/#sink-기반-증분-쓰기)를 권장합니다. 1GiB writer 벤치마크에서 sync sink 경로가 가장 높은 쓰기 처리량을 보였고, peak RSS는 async 쓰기와 같은 범위에 머물렀습니다.
