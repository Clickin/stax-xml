...
slug: ko/v0.7.0/converter/writing-xml
---
...
- [예제](/stax-xml/ko/v0.7.0/converter/examples)에서 완전한 양방향 스키마 확인
- [스키마 타입](/stax-xml/ko/v0.7.0/converter/schemas)에서 쓰기 중 유효성 검사 검토
- [변환](/stax-xml/ko/v0.7.0/converter/transformations)에서 데이터 준비 확인
- [XPath](/stax-xml/ko/v0.7.0/converter/xpath-guide)로 정확한 필드 매핑 학습
