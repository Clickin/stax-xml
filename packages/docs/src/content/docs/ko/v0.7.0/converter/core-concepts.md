...
slug: ko/v0.7.0/converter/core-concepts
---
...
- [스키마 타입](/stax-xml/ko/v0.7.0/converter/schemas)에서 상세 API 레퍼런스 탐색
- [XPath 패턴](/stax-xml/ko/v0.7.0/converter/xpath-guide)으로 요소 선택 학습
- [변환](/stax-xml/ko/v0.7.0/converter/transformations)에서 데이터 처리 확인
- [예제](/stax-xml/ko/v0.7.0/converter/examples)에서 실전 패턴 확인
