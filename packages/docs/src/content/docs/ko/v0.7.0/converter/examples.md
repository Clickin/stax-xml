...
slug: ko/v0.7.0/converter/examples
---
...
- [스키마 타입](/stax-xml/ko/v0.7.0/converter/schemas)에서 사용 가능한 모든 메서드 검토
- [변환](/stax-xml/ko/v0.7.0/converter/transformations)에서 데이터 처리 학습
- [XPath](/stax-xml/ko/v0.7.0/converter/xpath-guide)로 요소 선택 마스터
- [XML 쓰기](/stax-xml/ko/v0.7.0/converter/writing-xml)에서 직렬화 확인
