...
slug: ko/v0.7.0/converter/transformations
---
...
- [XML 쓰기](/stax-xml/ko/v0.7.0/converter/writing-xml)에서 직렬화 학습
- [예제](/stax-xml/ko/v0.7.0/converter/examples)에서 실전 transform 사용 확인
- [스키마 타입](/stax-xml/ko/v0.7.0/converter/schemas)에서 유효성 검사 옵션 검토
- [핵심 개념](/stax-xml/ko/v0.7.0/converter/core-concepts)에서 기본 사항 확인
