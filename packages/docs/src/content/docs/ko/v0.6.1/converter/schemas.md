...
slug: ko/v0.6.1/converter/schemas
---
...
- [XPath 패턴](/stax-xml/ko/v0.6.1/converter/xpath-guide)으로 고급 요소 선택 학습
- [변환](/stax-xml/ko/v0.6.1/converter/transformations)에서 데이터 처리 탐색
