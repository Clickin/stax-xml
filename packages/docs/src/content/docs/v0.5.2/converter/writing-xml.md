...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/converter/writing-xml.png
slug: v0.5.2/converter/writing-xml
---
...
- See [Examples](/stax-xml/v0.5.2/converter/examples) for complete bi-directional schemas
- Review [Schema Types](/stax-xml/v0.5.2/converter/schemas) for validation during writing
- Check [Transformations](/stax-xml/v0.5.2/converter/transformations) for data preparation
- Learn [XPath](/stax-xml/v0.5.2/converter/xpath-guide) for precise field mapping
