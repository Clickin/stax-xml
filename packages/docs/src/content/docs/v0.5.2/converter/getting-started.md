...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/converter/getting-started.png
slug: v0.5.2/converter/getting-started
---
...
- Learn about [Core Concepts](/stax-xml/v0.5.2/converter/core-concepts) and schema fundamentals
...
- See [Examples](/stax-xml/v0.5.2/converter/examples) for real-world usage patterns
