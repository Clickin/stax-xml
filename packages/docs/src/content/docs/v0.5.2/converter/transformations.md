...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/converter/transformations.png
slug: v0.5.2/converter/transformations
---
...
- Learn about [Writing XML](/stax-xml/v0.5.2/converter/writing-xml) for serialization
- See [Examples](/stax-xml/v0.5.2/converter/examples) for real-world transform usage
- Review [Schema Types](/stax-xml/v0.5.2/converter/schemas) for validation options
- Check [Core Concepts](/stax-xml/v0.5.2/converter/core-concepts) for fundamentals
