...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/converter/core-concepts.png
slug: v0.5.2/converter/core-concepts
---
...
- Explore [Schema Types](/stax-xml/v0.5.2/converter/schemas) for detailed API reference
- Learn [XPath patterns](/stax-xml/v0.5.2/converter/xpath-guide) for element selection
- See [Transformations](/stax-xml/v0.5.2/converter/transformations) for data processing
- Check [Examples](/stax-xml/v0.5.2/converter/examples) for real-world patterns
