...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/guide/getting-started.png
slug: v0.5.2/guide/getting-started
---
...
- [Quick Start Guide](/stax-xml/v0.5.2/guide/quick-start/) - Jump right in with practical examples
- [Examples](/stax-xml/v0.5.2/guide/examples/) - See real-world usage patterns