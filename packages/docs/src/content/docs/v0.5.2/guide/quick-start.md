...
- Explore more [Examples](/stax-xml/v0.5.2/guide/examples/) for advanced use cases
- See [Benchmarks](/stax-xml/v0.5.2/resources/benchmarks/) for performance comparisons