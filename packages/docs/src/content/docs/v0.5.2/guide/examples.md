...
- See [Performance Benchmarks](/stax-xml/v0.5.2/resources/benchmarks/) for comparison data
- Visit our [FAQ](/stax-xml/v0.5.2/resources/faq/) for troubleshooting help