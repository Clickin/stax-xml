...
plus index accessors. The manual baseline creates the same selected object
layout, but it remains a fixture-specific lower bound rather than a schema
wrapper. The converter rows parse the same byte fixture through:
