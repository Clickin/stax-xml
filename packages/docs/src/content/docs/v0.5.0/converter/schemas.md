...
- Learn [XPath patterns](/stax-xml/v0.5.0/converter/xpath-guide) for advanced element selection
- Explore [Transformations](/stax-xml/v0.5.0/converter/transformations) for data processing
- See [Writing XML](/stax-xml/v0.5.0/converter/writing-xml) for serialization
