...
- See [Performance Benchmarks](/stax-xml/v0.5.0/resources/benchmarks/) for comparison data
- Visit our [FAQ](/stax-xml/v0.5.0/resources/faq/) for troubleshooting help