...
- Explore more [Examples](/stax-xml/v0.5.0/guide/examples/) for advanced use cases
- See [Benchmarks](/stax-xml/v0.5.0/resources/benchmarks/) for performance comparisons