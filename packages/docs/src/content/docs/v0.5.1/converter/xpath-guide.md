...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/converter/xpath-guide.png
slug: v0.5.1/converter/xpath-guide
---
...
- Learn about [Transformations](/stax-xml/v0.5.1/converter/transformations) for post-processing
- See [Schema Types](/stax-xml/v0.5.1/converter/schemas) for validation options
- Explore [Examples](/stax-xml/v0.5.1/converter/examples) for real-world XPath usage
- Check [Writing XML](/stax-xml/v0.5.1/converter/writing-xml) for serialization
