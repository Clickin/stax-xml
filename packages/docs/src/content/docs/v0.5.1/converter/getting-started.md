...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/converter/getting-started.png
slug: v0.5.1/converter/getting-started
---
...
- Learn about [Core Concepts](/stax-xml/v0.5.1/converter/core-concepts) and schema fundamentals
- Explore [Schema Types](/stax-xml/v0.5.1/converter/schemas) for detailed API reference
- Master [XPath](/stax-xml/v0.5.1/converter/xpath-guide) for element selection
- See [Examples](/stax-xml/v0.5.1/converter/examples) for real-world usage patterns
