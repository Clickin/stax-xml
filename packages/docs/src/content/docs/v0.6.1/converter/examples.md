...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/converter/examples.png
slug: v0.6.1/converter/examples
---
...
- Review [Schema Types](/stax-xml/v0.6.1/converter/schemas) for all available methods
- Learn [Transformations](/stax-xml/v0.6.1/converter/transformations) for data processing
