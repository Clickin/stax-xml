...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/converter/core-concepts.png
slug: v0.6.1/converter/core-concepts
---
...
- Learn [XPath patterns](/stax-xml/v0.6.1/converter/xpath-guide) for element selection
- See [Transformations](/stax-xml/v0.6.1/converter/transformations) for data processing
- Check [Examples](/stax-xml/v0.6.1/converter/examples) for real-world patterns
