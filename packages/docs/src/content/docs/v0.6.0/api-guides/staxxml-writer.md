...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/api-guides/staxxml-writer.png
slug: v0.6.0/api-guides/staxxml-writer
---
...
> **Note**: For synchronous, in-memory XML generation, see [StaxXmlWriterSync](/stax-xml/v0.6.0/api-guides/staxxml-writer-sync/) which builds XML as a string.
