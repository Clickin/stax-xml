...
**[🚀 Open in Full Screen](/stax-xml/v0.6.0/demos/converter)** for the best experience.
...
- [Core Concepts](/stax-xml/v0.6.0/converter/core-concepts) - Learn the fundamentals
- [Schema Types](/stax-xml/v0.6.0/converter/schemas) - Explore all available schema types
- [XPath Guide](/stax-xml/v0.6.0/converter/xpath-guide) - Master XPath expressions
- [Examples](/stax-xml/v0.6.0/converter/examples) - More real-world examples
