...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/converter/getting-started.png
slug: v0.6.0/converter/getting-started
---
...
- Learn about [Core Concepts](/stax-xml/v0.6.0/converter/core-concepts) and schema fundamentals
...
- See [Examples](/stax-xml/v0.6.0/converter/examples) for real-world usage patterns
