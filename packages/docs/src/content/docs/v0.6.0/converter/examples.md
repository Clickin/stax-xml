...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/converter/examples.png
slug: v0.6.0/converter/examples
---
...
- Review [Schema Types](/stax-xml/v0.6.0/converter/schemas) for all available methods
- Learn [Transformations](/stax-xml/v0.6.0/converter/transformations) for data processing
- Master [XPath](/stax-xml/v0.6.0/converter/xpath-guide) for element selection
