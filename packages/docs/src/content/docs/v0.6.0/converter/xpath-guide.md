...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/converter/xpath-guide.png
slug: v0.6.0/converter/xpath-guide
---
...
- Learn about [Transformations](/stax-xml/v0.6.0/converter/transformations) for post-processing
- See [Schema Types](/stax-xml/v0.6.0/converter/schemas) for validation options
- Explore [Examples](/stax-xml/v0.6.0/converter/examples) for real-world XPath usage
- Check [Writing XML](/stax-xml/v0.6.0/converter/writing-xml) for serialization
