...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/converter/examples.png
slug: v1.0.0-rc1/converter/examples
---
...
- Review [Schema Types](/stax-xml/converter/schemas) for all available methods
- Learn [Transformations](/stax-xml/converter/transformations) for data processing
