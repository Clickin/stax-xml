...
head:
  ...
  - tag: meta
    attrs:
      name: twitter:image
      content: https://clickin.github.io/stax-xml/og/converter/xpath-guide.png
slug: v1.0.0-rc1/converter/xpath-guide
---
...
- Learn about [Transformations](/stax-xml/converter/transformations) for post-processing
- See [Schema Types](/stax-xml/converter/schemas) for validation options
- Explore [Examples](/stax-xml/converter/examples) for real-world XPath usage
- Check [Writing XML](/stax-xml/converter/writing-xml) for serialization
