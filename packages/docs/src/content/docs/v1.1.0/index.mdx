...
[Build an XML transformation pipeline →](/stax-xml/guide/event-pipelines/)
...
<CardGrid>
  ...
  <Card title="🔄 Streaming XML Parser" icon="down-arrow">
    Memory-efficient parsing and read-modify-write pipelines. Process XML files of any size without loading the entire document. [Learn Streaming API](/stax-xml/api-guides/event-reader/)
  </Card>
