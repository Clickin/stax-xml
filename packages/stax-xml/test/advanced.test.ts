...
describe('EventReader Edge Cases and Error Handling', () => {
...
describe('Writer Advanced Features', () => {
  it('should write complex nested structure with pretty print', async () => {
    ...
    writer.writeComment('Generated by Writer');
    ...
    expect(result).toContain('<!-- Generated by Writer -->');
  ...
  it('should handle method chaining', async () => {
    ...
    writer.writeStartDocument();
    writer.writeStartElement('chaining');
    writer.writeAttribute('test', 'true');
    writer.writeStartElement('nested');
    writer.writeCharacters('Method chaining works!');
    writer.writeEndElement();
  ...
  it('should validate state transitions and throw appropriate errors', async () => {
    ...
    expect(() => writer.writeAttribute('attr', 'value')).toThrow('writeAttribute can only be called after writeStartElement');

    // Test: Can't write namespace without start element
    expect(() => writer.writeNamespace('ns', 'http://example.com')).toThrow('writeNamespace can only be called after writeStartElement');

    // Test: Can't end element that's not opened
    expect(() => writer.writeEndElement()).toThrow('No open element to close');

    // Test: Can't write start document twice
    writer.writeStartDocument();
    expect(() => writer.writeStartDocument()).toThrow('writeStartDocument can only be called once at the beginning');
  });
});
