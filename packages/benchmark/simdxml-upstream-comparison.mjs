...
function createMarkdown(report) {
  const lines = [
    ...
    '',
    'This benchmark reuses the upstream simdxml benchmark fixture lists and compares `simdxml::parse(&data)` with the stax-xml native aggregate addon over the same read-once in-memory bytes.',
    '',
    '## Environment',
    '',
