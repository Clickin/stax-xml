...
Generated: 2026-05-26T15:17:21.328Z
...
- Cases: rawFrameNameId, rawFrameNameIdUnrolledMediumAsciiText, withoutTextStrings
...
- Output dir: G:\programming\stax-xml\packages\benchmark\results\cross-process\unrolled-medium-ascii-text-books-corpus-release
- Committed: no
...
| --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- | --- | ---: |
| rawFrameNameId | stream-events | 110.12 MiB/s | 109.59 MiB/s | 111.02 MiB/s | 1.3% | 109.59, 111.02, 109.76 | yes | yes | not-found | 66.8 MiB |
| rawFrameNameIdUnrolledMediumAsciiText | stream-events | 89.82 MiB/s | 88.93 MiB/s | 90.60 MiB/s | 1.9% | 89.95, 88.93, 90.60 | yes | yes | not-found | 67.9 MiB |
| withoutTextStrings | stream-events | 115.77 MiB/s | 114.52 MiB/s | 117.96 MiB/s | 3.0% | 114.52, 114.84, 117.96 | yes | yes | not-found | 69.8 MiB |

### Parity

- Full-string stream rows stable across processes: yes
- Full-string stream rows: rawFrameNameId, rawFrameNameIdUnrolledMediumAsciiText
...
| Variant | Count kind | Avg throughput | Min | Max | Spread | Samples | Stable result | Bounded all | Counterexample | Max RSS |
| --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- | --- | ---: |
| rawFrameNameId | stream-events | 120.68 MiB/s | 119.21 MiB/s | 121.75 MiB/s | 2.1% | 119.21, 121.08, 121.75 | yes | yes | not-found | 180.7 MiB |
| rawFrameNameIdUnrolledMediumAsciiText | stream-events | 92.68 MiB/s | 92.27 MiB/s | 93.37 MiB/s | 1.2% | 92.39, 92.27, 93.37 | yes | yes | not-found | 179.6 MiB |
| withoutTextStrings | stream-events | 131.65 MiB/s | 131.27 MiB/s | 132.07 MiB/s | 0.6% | 131.62, 131.27, 132.07 | yes | yes | not-found | 176.8 MiB |
