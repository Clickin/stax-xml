...
Generated: 2026-05-31T14:56:33.272Z
...
| --- | --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | --- | ---: | ---: | --- |
| rawFrameNameId | full-stax-js | full-string-materialization | stream-events | materialization-counters-enabled | 154.05 MiB/s | 1.00x | 0.51x | below | yes | not-found | 57096514 | -540013997 | yes |
| rawFrameNameIdNoCounters | full-stax-js | full-string-materialization | stream-events | materialization-counters-disabled | 167.72 MiB/s | 1.00x | 0.55x | below | yes | not-found | 57096514 | -540013997 | yes |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| rawFrameNameId | 3 | 6647.35 | 6431.18 | 6990.81 | 8.4% | 6520.05, 6990.81, 6431.18 |
| rawFrameNameIdNoCounters | 3 | 6105.46 | 5992.78 | 6266.84 | 4.5% | 6056.75, 6266.84, 5992.78 |
...
| --- | ---: | ---: | ---: | ---: |
| rawFrameNameId | +1.1 MiB | +2.5 MiB | 6.8 MiB | 66.8 MiB |
| rawFrameNameIdNoCounters | +1.6 MiB | +2.1 MiB | 7.0 MiB | 73.2 MiB |
...
Full-string parity rows: ok, events=57096514, checksum=-540013997, rows=rawFrameNameId, rawFrameNameIdNoCounters.
...
- bounded-memory-contract: Rows consume corpus-backed Uint8Array batches and do not load a full XML string.
  ...
  - rawFrameNameIdNoCounters: maxRSS=73.2 MiB
...
- headroom-search: The fastest row in each family is a headroom signal, not a runtime-limit conclusion.
  - partial=missing
  - full=rawFrameNameIdNoCounters 167.72 MiB/s
- materialization-counter-overhead-candidate: rawFrameNameIdNoCounters keeps the full-string checksum while removing in-loop materialization counter increments, isolating benchmark instrumentation overhead from parser/string cost.
  - rawFrameNameId=154.05 MiB/s
  - rawFrameNameIdNoCounters=167.72 MiB/s
  - sameChecksum=true
  - sameEvents=true
