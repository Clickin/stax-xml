...
Generated: 2026-05-25T01:31:25.426Z
...
| --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | --- | ---: | ---: | --- |
| stringFull | full-stax-js | full-string-materialization | stream-events | 165.91 MiB/s | 1.00x | 0.50x | below | yes | not-found | 57096514 | -540013997 | yes |
| rawFrameNameId | full-stax-js | full-string-materialization | stream-events | 152.11 MiB/s | 0.92x | 0.46x | below | yes | not-found | 57096514 | -540013997 | yes |
| rawFrameNameIdLongAsciiText | full-stax-js | full-string-materialization | stream-events | 66.10 MiB/s | 0.40x | 0.20x | below | yes | not-found | 57096514 | -540013997 | yes |
| withoutTextStrings | near-full-upper-bound | full-materialization-minus-text-cdata | stream-events | 148.22 MiB/s | 0.89x | 0.44x | not-applicable | yes | not-found | 57096514 | 1372281363 | no |
...
| --- | ---: | ---: | ---: | ---: |
| stringFull | +1.9 MiB | +5.8 MiB | 6.6 MiB | 69.6 MiB |
| rawFrameNameId | +1.5 MiB | +368.0 KiB | 6.6 MiB | 70.0 MiB |
| rawFrameNameIdLongAsciiText | +3.3 MiB | +12.4 MiB | 8.5 MiB | 82.4 MiB |
| withoutTextStrings | +6.0 MiB | +10.5 MiB | 11.2 MiB | 93.1 MiB |
...
- bounded-memory-contract: Rows consume corpus-backed Uint8Array batches and do not load a full XML string.
  - stringFull: maxRSS=69.6 MiB
  - rawFrameNameId: maxRSS=70.0 MiB
  - rawFrameNameIdLongAsciiText: maxRSS=82.4 MiB
...
- headroom-search: The fastest row in each family is a headroom signal, not a runtime-limit conclusion.
  - partial=withoutTextStrings 148.22 MiB/s
  - full=stringFull 165.91 MiB/s
- long-ascii-text-materialization-candidate: rawFrameNameIdLongAsciiText keeps the full-string checksum while replacing TextDecoder on ASCII text/CDATA spans longer than the short-span fast path.
  - rawFrameNameId=152.11 MiB/s
  - rawFrameNameIdLongAsciiText=66.10 MiB/s
  - sameChecksum=true
