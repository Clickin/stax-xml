...
Generated: 2026-05-31T15:57:38.573Z
...
- Aggregated rows: 213
- 1 GiB+ JavaScript full-string rows: 182
...
- 1 GiB+ JS full-string memory frontier: 165/182 bounded rows; fastest bounded row Node/V8 rawFrameNameId at 185.50 MiB/s (process RSS max 60.45 MiB)
...
- 1 GiB+ JS full-string source-mode rows not using full ArrayBuffer parser input: 176/176
- 1 GiB+ source-mode rows replaying a corpus seed buffer: 99 (max seed 100.26 MiB, max seed/target 0.09)
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 GiB+ JS full-string rows with source mode metadata | 176 | 176 | 0 | 0 | 99 | 100.26 MiB |
...
| process-rss | 153 | 145 | 8 | 1956.69 MiB | Node/V8 rawFrameNameId at 185.50 MiB/s (process RSS max 60.45 MiB) | Node/V8 rawFrameNameId at 185.50 MiB/s (process RSS max 60.45 MiB) |
