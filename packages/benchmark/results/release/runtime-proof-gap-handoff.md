...
Generated: 2026-06-01T07:14:20.889Z
...
- 1 GiB+ JS full-string source-mode rows not using full ArrayBuffer parser input: 224/224
- Full ArrayBuffer parser-input rows: 0
- Unknown parser-input rows: 0
- Corpus seed replay rows: 141
...
| sync-iterable-byte-batches | 186 | 186 | 0 | 139 | Node/V8 rawFrameNameId 185.50 MiB/s from text-trim-cost-decomposition.json |
...
- 1 GiB+ JS full-string memory rows: 230
- Bounded rows: 213
...
| process-rss | 201 | 193 | 8 | 1956.69 MiB | Node/V8 rawFrameNameId 185.50 MiB/s (process-rss max 60.45 MiB) | Node/V8 rawFrameNameId 185.50 MiB/s (process-rss max 60.45 MiB) |
