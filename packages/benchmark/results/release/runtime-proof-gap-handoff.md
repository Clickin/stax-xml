...
Generated: 2026-06-03T06:05:53.227Z
...
- Audit generated: 2026-06-03T06:05:26.749Z
...
- Diagnostic identity status counts: not-claimed=4, not-claimed-non-stax-diagnostic=8
- Local blockers:
  ...
  - The js-shell StAX API gap audit pins the unchanged-harness blocker as host API surface, with unchanged harness missing globals: TextEncoder, ReadableStream, fetch, primary sync byte-batch missing globals: none, primary path runnable without host encoding globals: unknown, non-primary harness missing globals: TextEncoder, ReadableStream, fetch, and direct unchanged harness attempts blocked before StAX load: 6/10.
  ...
  - A current Taskcluster debug js-shell emits JitSpew codegen output (taskId=azB5UO80Q3KJPPyXD0C8tA, artifactName=public/build/target.jsshell.zip, artifactUrl=https://firefox-ci-tc.services.mozilla.com/api/queue/v1/task/azB5UO80Q3KJPPyXD0C8tA/artifacts/public/build/target.jsshell.zip, buildId=20260602214419, sourceRevision=e4f9cbec72268c8efc0137a1d593e24af3df0712), but sameContractStaxRow=false, canRunCurrentStaxFullStringBenchmark=false, and selectedRowIdentityStatus=not-claimed-non-stax-diagnostic.
  - A current Taskcluster debug js-shell emits JitSpew codegen output while running the XML byte-tokenizer workload (taskId=azB5UO80Q3KJPPyXD0C8tA, artifactName=public/build/target.jsshell.zip, artifactUrl=https://firefox-ci-tc.services.mozilla.com/api/queue/v1/task/azB5UO80Q3KJPPyXD0C8tA/artifacts/public/build/target.jsshell.zip, buildId=20260602214419, sourceRevision=e4f9cbec72268c8efc0137a1d593e24af3df0712), but fullStringParity=false, sameContractStaxRow=false, canRunCurrentStaxFullStringBenchmark=false, and selectedRowIdentityStatus=not-claimed-non-stax-diagnostic.
  - A current Taskcluster debug js-shell emits JitSpew codegen output while materializing JS strings and public event-shaped objects (taskId=azB5UO80Q3KJPPyXD0C8tA, artifactName=public/build/target.jsshell.zip, artifactUrl=https://firefox-ci-tc.services.mozilla.com/api/queue/v1/task/azB5UO80Q3KJPPyXD0C8tA/artifacts/public/build/target.jsshell.zip, buildId=20260602214419, sourceRevision=e4f9cbec72268c8efc0137a1d593e24af3df0712), but unchangedStaxBenchmark=false, sameContractStaxRow=false, canRunCurrentStaxFullStringBenchmark=false, and selectedRowIdentityStatus=not-claimed-non-stax-diagnostic.
  - A rerun of the current Taskcluster debug js-shell codegen probe reproduces JitSpew output (taskId=azB5UO80Q3KJPPyXD0C8tA, artifactName=public/build/target.jsshell.zip, artifactUrl=https://firefox-ci-tc.services.mozilla.com/api/queue/v1/task/azB5UO80Q3KJPPyXD0C8tA/artifacts/public/build/target.jsshell.zip, buildId=20260602214419, sourceRevision=e4f9cbec72268c8efc0137a1d593e24af3df0712, codegenMarkers=54761), but sameContractStaxRow=false, canRunCurrentStaxFullStringBenchmark=false, and closesEmittedIrObligation=false.
  - A rerun of the current Taskcluster debug js-shell materialized string/object probe reproduces JitSpew output (taskId=azB5UO80Q3KJPPyXD0C8tA, artifactName=public/build/target.jsshell.zip, artifactUrl=https://firefox-ci-tc.services.mozilla.com/api/queue/v1/task/azB5UO80Q3KJPPyXD0C8tA/artifacts/public/build/target.jsshell.zip, buildId=20260602214419, sourceRevision=e4f9cbec72268c8efc0137a1d593e24af3df0712, codegenMarkers=234582, throughputMiBPerSec=0.76), but unchangedStaxBenchmark=false, sameContractStaxRow=false, canRunCurrentStaxFullStringBenchmark=false, and closesEmittedIrObligation=false.
  - Coverage diagnostic identity status counts: selectedRowIdentityStatusCounts not-claimed=4, not-claimed-non-stax-diagnostic=8.
...
- stax-public-reader-host-api-boundary: Re-pin the current StAX public reader UTF-8 fallback and host API boundary before evaluating js-shell closure.
...
- rejectionRule: Reject materialized js-shell evidence while selected-row identity, unchanged benchmark status, or emitted-codegen closure metadata remains blocked.
