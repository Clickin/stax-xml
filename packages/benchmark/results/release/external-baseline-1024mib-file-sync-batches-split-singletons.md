...
Generated: 2026-05-26T09:16:57.265Z
...
| --- | --- | ---: | ---: | ---: | --- | ---: | ---: | ---: | --- |
| stax-stream | Node + stax-xml StreamReaderSync file-backed Iterable<Uint8Array[]> split into singleton parser batches | 116.9 MiB/s | 66.7 MiB | n/a | unknown | 8759.95 ms | 61236571 | -716099804 | ok |
| stax-raw-frame-name-id | Node + stax-xml nextRawBatch name-id cache file-backed Iterable<Uint8Array[]> split into singleton parser batches | 129.3 MiB/s | 77.8 MiB | n/a | unknown | 7917.00 ms | 61236571 | -716099804 | ok |
...
- `file-sync-batches-split-singletons` reads grouped file chunks, then yields singleton `Uint8Array[]` parser batches to reduce current parser multi-item concat while preserving the same demand-driven source contract.
