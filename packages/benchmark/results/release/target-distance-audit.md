...
Generated: 2026-06-03T09:26:08.548Z
...
| `same-fixture-fastest-js-contract-classified` | SOURCE_FACT | The same-fixture fastest JavaScript target row preserves the full-string event/checksum contract against Woodstox and quick-xml, is file-backed synchronous Iterable<Uint8Array[]> input, not direct ReadableStream, not full ArrayBuffer parser input, and bounded under process RSS. |
