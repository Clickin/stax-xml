...
| stax-xml EventReaderSync (JS) | 292.88 µs | ~3,414 ops/sec | 71.83 kb | Public lean string event reader with the JavaScript fallback backend |
...
| stax-xml EventReaderSync (JS) | 396.37 µs | ~2,523 ops/sec | 101.00 kb | Public lean string event reader with the JavaScript fallback backend |
...
| stax-xml EventReaderSync (JS) | 165.81 ms | ~6.03 ops/sec | 22.97 mb | Public lean string event reader with the JavaScript fallback backend |
...
| stax-xml EventReaderSync (JS) | 1.13 s | ~0.89 ops/sec | 61.89 mb | Public lean string event reader with the JavaScript fallback backend |
...
|-----------|-------------|-----------------|--------------|-------------------|
| 1MiB temp file | **EventReader stream JS fallback** | 239.32 ms | 20.79 mb | Baseline, 4.18 MiB/s |
| 1MiB temp file | EventReader stream native | 33.73 ms | 46.97 mb | 7.09x faster, 29.64 MiB/s |
| 10MiB temp file | **EventReader stream JS fallback** | 442.02 ms | 104.36 mb | Baseline, 22.62 MiB/s |
| 10MiB temp file | EventReader stream native | 297.01 ms | 74.26 mb | 1.49x faster, 33.67 MiB/s |
| 100MiB temp file | **EventReader stream JS fallback** | 4.09 s | 115.86 mb | Baseline, 24.47 MiB/s |
| 100MiB temp file | EventReader stream native | 2.97 s | 59.67 mb | 1.38x faster, 33.70 MiB/s |
| 1GiB temp file | **EventReader stream JS fallback** | 41.91 s | 189.49 mb | Baseline, 24.43 MiB/s |
