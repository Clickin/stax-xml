...
Generated: 2026-05-26T05:20:42.533Z
...
| --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | --- | ---: | ---: | --- |
| rawFrameNameId | full-stax-js | full-string-materialization | stream-events | 109.66 MiB/s | 1.00x | 0.36x | below | yes | not-found | 45189256 | 1421012805 | yes |
| rawFrameNameIdTrimGuard | full-stax-js | full-string-materialization | stream-events | 109.56 MiB/s | 1.00x | 0.36x | below | yes | not-found | 45189256 | 1421012805 | yes |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| rawFrameNameId | 3 | 9338.16 | 9311.52 | 9375.28 | 0.7% | 9311.52, 9327.67, 9375.28 |
| rawFrameNameIdTrimGuard | 3 | 9346.48 | 9294.73 | 9387.16 | 1.0% | 9294.73, 9357.54, 9387.16 |
...
| --- | ---: | ---: | ---: | ---: |
| rawFrameNameId | +3.0 MiB | +4.6 MiB | 9.7 MiB | 77.9 MiB |
| rawFrameNameIdTrimGuard | +2.2 MiB | +786.7 KiB | 8.7 MiB | 78.7 MiB |
...
| rawFrameNameIdTrimGuard | 102,702,850 | 32,864,912 | 12,324,342 | 28,756,798 | 28,756,798 | 41,087,307 | 61,615,543/6,167 | 0/0 | 0/0 | 0/0 | 0 | 0 | 0 | 28,756,798 |
...
Full-string parity rows: ok, events=45189256, checksum=1421012805, rows=rawFrameNameId, rawFrameNameIdTrimGuard.
...
- bounded-memory-contract: Rows consume generated Uint8Array batches and do not load a full XML string.
  - rawFrameNameId: maxRSS=77.9 MiB
  - rawFrameNameIdTrimGuard: maxRSS=78.7 MiB
...
- text-trim-guard-candidate: rawFrameNameIdTrimGuard keeps the full-string checksum while skipping value.trim() when byte boundaries prove the text span is unchanged by trim.
  - rawFrameNameId=109.66 MiB/s
  - rawFrameNameIdTrimGuard=109.56 MiB/s
  - sameChecksum=true
  - trimGuardSkips=11950239
  - trimGuardFallbacks=374103
