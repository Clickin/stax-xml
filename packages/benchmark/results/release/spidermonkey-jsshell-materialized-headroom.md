...
Generated: 2026-06-01T18:55:26.382Z
...
- Rows: 2
- Fastest row: nightly-spidermonkey-materialized-string-object at 37.80 MiB/s
...
| --- | --- | ---: | --- | --- | --- | ---: | ---: |
| `release-spidermonkey-materialized-string-object` | JavaScript-C143.0.1 | 33.24 | no | yes | none | 980607 | 892131 |
| `nightly-spidermonkey-materialized-string-object` | JavaScript-C153.0a1 | 37.80 | no | yes | none | 980607 | 892131 |

## Findings

- spidermonkey-materialized-headroom (LIMITED_EVIDENCE_PRESENT): Fastest SpiderMonkey js-shell materialized string/object row is 37.80 MiB/s.
