...
Generated: 2026-05-23T23:14:33.612Z
...
| --- | --- | --- | --- | --- | ---: | --- | --- | ---: | ---: |
| subarraySharedDecoder | Uint8Array.subarray | per-run-shared | no | no | 53.29 MiB/s | yes | not-found | 75206126 | -925527041 |
| viewSharedDecoder | Uint8Array constructor view | per-run-shared | no | no | 48.29 MiB/s | yes | not-found | 75206126 | -925527041 |
| sliceCopySharedDecoder | Uint8Array copy | per-run-shared | yes | no | 42.88 MiB/s | yes | not-found | 75206126 | -925527041 |
| subarrayNewDecoder | Uint8Array.subarray | per-span-new | no | no | 44.67 MiB/s | yes | not-found | 75206126 | -925527041 |
| shortAsciiSubarraySharedDecoder | Uint8Array.subarray | per-run-shared | no | yes | 69.16 MiB/s | yes | not-found | 75206126 | -925527041 |
...
| --- | ---: | ---: | ---: | ---: |
| subarraySharedDecoder | +855.8 KiB | +124.0 MiB | 5.3 MiB | 354.3 MiB |
| viewSharedDecoder | +925.4 KiB | -13.1 MiB | 5.7 MiB | 354.4 MiB |
| sliceCopySharedDecoder | +1.6 MiB | +1.4 MiB | 5.5 MiB | 342.8 MiB |
| subarrayNewDecoder | +1.7 MiB | +21.1 MiB | 5.6 MiB | 364.0 MiB |
| shortAsciiSubarraySharedDecoder | +1.5 MiB | -14.0 MiB | 5.5 MiB | 362.2 MiB |
...
- textdecoder-variants-are-headroom-search (BENCH_FACT): Fastest row in this run was shortAsciiSubarraySharedDecoder at 69.16 MiB/s; this is a decode-span headroom search, not an impossibility proof.
...
- Fastest row: shortAsciiSubarraySharedDecoder at 69.16 MiB/s.
