...
Generated: 2026-06-01T06:22:54.418Z
...
| --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| readableStreamBatch1 | readable-stream | web-readable-stream-pull | ReadableStream<Uint8Array> | yes | yes | yes | 1 | 13.71 MiB/s | 46195346 | -577171566 | 5774419 | 5774418 | yes | 100.2 MiB |
| readableStreamBatch16 | readable-stream | web-readable-stream-pull | ReadableStream<Uint8Array> | yes | yes | yes | 16 | 16.78 MiB/s | 46195346 | -577171566 | 5774419 | 5774418 | yes | 137.7 MiB |
| readableStreamBatch64 | readable-stream | web-readable-stream-pull | ReadableStream<Uint8Array> | yes | yes | yes | 64 | 18.08 MiB/s | 46195346 | -577171566 | 5774419 | 5774418 | yes | 140.6 MiB |
| asyncByteBatch16 | async-byte-batch | async-iterable-byte-batches | AsyncIterable<Uint8Array[]> | no | yes | yes | 16 | 18.24 MiB/s | 46195346 | -577171566 | 5774418 | 360902 | yes | 141.1 MiB |
| asyncByteBatch64 | async-byte-batch | async-iterable-byte-batches | AsyncIterable<Uint8Array[]> | no | yes | yes | 64 | 19.03 MiB/s | 46195346 | -577171566 | 5774418 | 90226 | yes | 143.0 MiB |
| syncIterableBatch1 | sync-iterable-byte-batch | sync-iterable-byte-batches | Iterable<Uint8Array[]> | no | no | yes | 1 | 30.48 MiB/s | 46195346 | -577171566 | 5774418 | 5774418 | yes | 147.6 MiB |
| syncIterableBatch16 | sync-iterable-byte-batch | sync-iterable-byte-batches | Iterable<Uint8Array[]> | no | no | yes | 16 | 37.98 MiB/s | 46195346 | -577171566 | 5774418 | 360902 | yes | 154.5 MiB |
| syncIterableBatch64 | sync-iterable-byte-batch | sync-iterable-byte-batches | Iterable<Uint8Array[]> | no | no | yes | 64 | 39.29 MiB/s | 46195346 | -577171566 | 5774418 | 90226 | yes | 158.0 MiB |
...
- fixture-cycle-source-scope (SOURCE_FACT): The benchmark isolates parser/source API overhead by replaying prepared fixture rows, not by streaming the full target size from OS, network, or browser fetch.
  ...
  - fileBackedRows=none
- async-byte-batch-headroom (BENCH_FACT): At batch size 16, async byte batches were 1.09x the ReadableStream row on this run; this row avoids direct ReadableStream consumption but still crosses an AsyncIterator source boundary.
  - readableStreamBatch16=16.78 MiB/s
  - asyncByteBatch16=18.24 MiB/s
- sync-iterable-byte-batch-headroom (BENCH_FACT): At batch size 16, sync iterable byte batches were 2.26x the ReadableStream row on this run; this is the row that removes the ReadableStream and AsyncIterator source boundary while preserving demand-driven pulls.
  - readableStreamBatch16=16.78 MiB/s
  - syncIterableBatch16=37.98 MiB/s
