...
Generated: 2026-05-24T02:07:31.743Z
...
- Scanned primary artifacts: 59
- Ignored derived artifacts: 4
- Measured rows recognized: 342
- Benchmark artifacts: 39
- Source artifacts: 9
- Trace/profile artifacts: 3
- Allocation artifacts: 9
- 1 GiB+ JS full-string rows: 141
- Corpus seeds: 1
- Open or partial obligations: 6
...
| Firefox/SpiderMonkey browser | 1 | 0 | 0 | none | 1 | 0 | 0 |
...
| --- | --- | --- | --- |
| `firefox-browser-rows-open` | open | Firefox/SpiderMonkey source pins exist only as source facts; no Firefox browser benchmark rows were found. | Wire a Firefox-capable browser harness row under the same full-string byte-batch contract. |
...
| `non-v8-browser-coverage-open` | open | Current browser benchmark rows are Chrome/V8 only; Firefox/SpiderMonkey and Safari/WebKit rows are absent. | Run same-contract 1 GiB+ browser rows on at least one non-V8 browser engine. |
...
- Firefox/SpiderMonkey browser benchmark rows: 0
- Safari/WebKit browser benchmark rows: 0
- Non-V8 browser benchmark rows: 0
...
- non-v8-browser-gap-remains (OPEN): No Firefox/SpiderMonkey or Safari/WebKit browser benchmark rows are present in current release artifacts.
...
- open-obligations-ranked (OPEN): 6 proof obligation(s) remain open or partial after scanning current release artifacts.
  - firefox-browser-rows-open
  - safari-jsc-source-and-browser-rows-open
  - codegen-traces-open
  - allocation-profiles-open
  - non-v8-browser-coverage-open
