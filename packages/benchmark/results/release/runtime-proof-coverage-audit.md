...
Generated: 2026-06-01T07:13:53.108Z
...
- Scanned primary artifacts: 216
- Ignored derived artifacts: 7
- Measured rows recognized: 1217
...
- Benchmark artifacts: 154
- Source artifacts: 24
- Trace/profile artifacts: 15
- Allocation artifacts: 16
- Environment artifacts: 4
- Negative-result artifacts: 24
- 1 GiB+ JS full-string rows: 821
- 1 GiB+ JS full-string source-mode rows not using full ArrayBuffer parser input: 447/447
...
| `generated-sync-iterable-byte-batches` | 355 | 355 | 0 | 0 | 0 | 355 | rawFrameNameId 185.50 MiB/s from text-trim-cost-decomposition.json |
...
| --- | ---: | ---: | ---: | --- | ---: | ---: | ---: |
| Node/V8 | 110 | 577 | 398 | rawFrameNameId 185.50 MiB/s from text-trim-cost-decomposition.json | 2 | 2 | 5 |
