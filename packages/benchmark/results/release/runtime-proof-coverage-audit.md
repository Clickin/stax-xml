...
Generated: 2026-05-24T06:20:02.909Z
...
- Scanned primary artifacts: 66
- Ignored derived artifacts: 5
- Measured rows recognized: 393
- Benchmark artifacts: 46
- Source artifacts: 9
- Trace/profile artifacts: 3
- Allocation artifacts: 9
- 1 GiB+ JS full-string rows: 184
- Corpus seeds: 1
...
| Firefox/SpiderMonkey browser | 8 | 51 | 43 | rawFrameNameId 69.68 MiB/s from firefox-bidi-candidate-headroom-cross-process-projection.json | 1 | 0 | 0 |
...
| --- | --- | --- | --- |
| `firefox-browser-rows-open` | covered | 51 Firefox/SpiderMonkey browser benchmark rows found. | Broaden Firefox coverage with corpus/projection rows plus SpiderMonkey codegen and allocation evidence. |
...
| `non-v8-browser-coverage-open` | covered | 51 non-V8 browser benchmark rows found. | Broaden non-V8 browser coverage with Safari/WebKit plus corpus/projection rows and allocation evidence. |
...
- Firefox/SpiderMonkey browser benchmark rows: 51
- Safari/WebKit browser benchmark rows: 0
- Non-V8 browser benchmark rows: 51
