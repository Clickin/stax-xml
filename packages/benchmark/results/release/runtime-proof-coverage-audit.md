...
Generated: 2026-05-24T04:14:09.434Z
...
- Scanned primary artifacts: 61
- Ignored derived artifacts: 5
- Measured rows recognized: 348
- Benchmark artifacts: 41
- Source artifacts: 9
- Trace/profile artifacts: 3
- Allocation artifacts: 9
- 1 GiB+ JS full-string rows: 147
- Corpus seeds: 1
...
| Firefox/SpiderMonkey browser | 3 | 6 | 6 | rawFrameNameId 48.15 MiB/s from firefox-bidi-candidate-headroom-corpus.json | 1 | 0 | 0 |
...
| --- | --- | --- | --- |
| `firefox-browser-rows-open` | covered | 6 Firefox/SpiderMonkey browser benchmark rows found. | Broaden Firefox coverage with corpus/projection rows plus SpiderMonkey codegen and allocation evidence. |
...
| `non-v8-browser-coverage-open` | covered | 6 non-V8 browser benchmark rows found. | Broaden non-V8 browser coverage with Safari/WebKit plus corpus/projection rows and allocation evidence. |
...
- Firefox/SpiderMonkey browser benchmark rows: 6
- Safari/WebKit browser benchmark rows: 0
- Non-V8 browser benchmark rows: 6
