...
Generated: 2026-05-24T05:53:49.195Z
...
| Firefox/SpiderMonkey browser | 7 | 36 | 28 | rawFrameNameId 69.68 MiB/s from firefox-bidi-candidate-headroom-cross-process-projection.json | 1 | 0 | 0 |
...
| --- | --- | --- | --- |
| `firefox-browser-rows-open` | covered | 36 Firefox/SpiderMonkey browser benchmark rows found. | Broaden Firefox coverage with corpus/projection rows plus SpiderMonkey codegen and allocation evidence. |
...
| `non-v8-browser-coverage-open` | covered | 36 non-V8 browser benchmark rows found. | Broaden non-V8 browser coverage with Safari/WebKit plus corpus/projection rows and allocation evidence. |
...
- Firefox/SpiderMonkey browser benchmark rows: 36
- Safari/WebKit browser benchmark rows: 0
- Non-V8 browser benchmark rows: 36
