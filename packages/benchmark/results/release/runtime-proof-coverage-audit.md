...
Generated: 2026-05-24T06:40:37.509Z
...
- Scanned primary artifacts: 67
- Ignored derived artifacts: 5
- Measured rows recognized: 408
- Benchmark artifacts: 47
- Source artifacts: 9
- Trace/profile artifacts: 3
- Allocation artifacts: 9
- 1 GiB+ JS full-string rows: 199
- Corpus seeds: 1
...
| Firefox/SpiderMonkey browser | 9 | 66 | 58 | shortAsciiSubarraySharedDecoder 69.98 MiB/s from firefox-bidi-textdecoder-span-cross-process-corpus.json | 1 | 0 | 0 |
...
| --- | --- | --- | --- |
| `firefox-browser-rows-open` | covered | 66 Firefox/SpiderMonkey browser benchmark rows found. | Broaden Firefox coverage with corpus/projection rows plus SpiderMonkey codegen and allocation evidence. |
...
| `non-v8-browser-coverage-open` | covered | 66 non-V8 browser benchmark rows found. | Broaden non-V8 browser coverage with Safari/WebKit plus corpus/projection rows and allocation evidence. |
...
- Firefox/SpiderMonkey browser benchmark rows: 66
- Safari/WebKit browser benchmark rows: 0
- Non-V8 browser benchmark rows: 66
