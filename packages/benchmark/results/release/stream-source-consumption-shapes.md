...
Generated: 2026-05-26T07:31:34.523Z
...
- Files:
  - packages/benchmark/stream-source-consumption-shapes.mjs (704 lines)
...
- Fastest row: web-readable-stream-pull 133.98 MiB/s, RSS 78.10 MiB
...
| --- | --- | ---: | ---: | ---: | --- | ---: | ---: | ---: | --- | --- |
| `sync-iterable-byte-batches` | Node + stax-xml StreamReaderSync over demand-driven Iterable<Uint8Array[]> file batches | 127.02 | 3 | 16.2% | yes | 66.47 MiB | 61236571 | -716099804 | yes | n/a |
| `web-readable-stream-pull` | Node + stax-xml StreamReader over backpressure-respecting ReadableStream<Uint8Array> pull source | 133.98 | 3 | 0.8% | yes | 78.10 MiB | 61236571 | -716099804 | yes | yes |
...
- current-release-source-shape (CONTRACT_FACT): The current file-backed release comparison uses the sync Iterable<Uint8Array[]> shape, not direct Web ReadableStream consumption.
  - sync-iterable-byte-batches: 127.02 MiB/s
- readable-stream-direct-source-shape (BENCH_FACT): Direct ReadableStream consumption reached 133.98 MiB/s (1.05x of sync Iterable<Uint8Array[]>); this is a separate source-shape row, not the current release comparison source.
  - sync-iterable-byte-batches=127.02 MiB/s rss=66.47 MiB
  - web-readable-stream-pull=133.98 MiB/s rss=78.10 MiB
