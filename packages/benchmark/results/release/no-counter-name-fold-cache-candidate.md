...
Generated: 2026-05-31T15:21:57.996Z
...
| --- | --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | --- | ---: | ---: | --- |
| rawFrameNameId | full-stax-js | full-string-materialization | stream-events | materialization-counters-enabled | 158.03 MiB/s | 1.00x | 0.52x | below | yes | not-found | 57096514 | -540013997 | yes |
| rawFrameNameIdNoCounters | full-stax-js | full-string-materialization | stream-events | materialization-counters-disabled | 166.22 MiB/s | 1.00x | 0.55x | below | yes | not-found | 57096514 | -540013997 | yes |
| rawFrameNameIdNoCountersNameFoldCache | full-stax-js | full-string-materialization | stream-events | materialization-counters-disabled | 170.17 MiB/s | 1.00x | 0.56x | below | yes | not-found | 57096514 | -540013997 | yes |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| rawFrameNameId | 3 | 6479.93 | 6361.35 | 6662.92 | 4.7% | 6415.53, 6662.92, 6361.35 |
| rawFrameNameIdNoCounters | 3 | 6160.35 | 6101.03 | 6275.48 | 2.8% | 6275.48, 6101.03, 6104.55 |
| rawFrameNameIdNoCountersNameFoldCache | 3 | 6017.45 | 5903.16 | 6103.80 | 3.3% | 6103.80, 5903.16, 6045.39 |
...
| --- | ---: | ---: | ---: | ---: |
| rawFrameNameId | +1.2 MiB | +2.2 MiB | 7.3 MiB | 66.6 MiB |
| rawFrameNameIdNoCounters | +1.5 MiB | +1.9 MiB | 7.5 MiB | 72.8 MiB |
| rawFrameNameIdNoCountersNameFoldCache | +1.8 MiB | +204.0 KiB | 7.8 MiB | 73.5 MiB |
...
Full-string parity rows: ok, events=57096514, checksum=-540013997, rows=rawFrameNameId, rawFrameNameIdNoCounters, rawFrameNameIdNoCountersNameFoldCache.
...
- bounded-memory-contract: Rows consume corpus-backed Uint8Array batches and do not load a full XML string.
  ...
  - rawFrameNameIdNoCounters: maxRSS=72.8 MiB
  - rawFrameNameIdNoCountersNameFoldCache: maxRSS=73.5 MiB
...
- headroom-search: The fastest row in each family is a headroom signal, not a runtime-limit conclusion.
  - partial=missing
  - full=rawFrameNameIdNoCountersNameFoldCache 170.17 MiB/s
- materialization-counter-overhead-candidate: rawFrameNameIdNoCounters keeps the full-string checksum while removing in-loop materialization counter increments, isolating benchmark instrumentation overhead from parser/string cost.
  - rawFrameNameId=158.03 MiB/s
  - rawFrameNameIdNoCounters=166.22 MiB/s
  - sameChecksum=true
  - sameEvents=true
...
- no-counter-name-fold-cache-candidate: rawFrameNameIdNoCountersNameFoldCache still materializes cached name strings, but reuses checksum transforms for repeated name ids to isolate benchmark consumer folding cost from parser/string creation cost.
  - rawFrameNameIdNoCounters=166.22 MiB/s
  - rawFrameNameIdNoCountersNameFoldCache=170.17 MiB/s
  - sameChecksum=true
  - sameEvents=true
