...
Generated: 2026-05-24T05:23:15.553Z
...
- Scanned artifacts: 63
- Ignored derived artifacts: 5
- Measured rows recognized: 368
- 1 GiB+ JS full-string rows recognized: 159
- Counterexamples found: 0
- Partial/projection threshold rows: 1
- Full-string rows without bounded-memory proof: 64
...
- unbounded-or-unknown-full-rows-not-counterexamples (LIMITED_EVIDENCE_PRESENT): 64 recognized 1 GiB+ full-string JavaScript row(s) lack bounded-memory proof and cannot close the counterexample rule.
