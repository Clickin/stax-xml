...
Generated: 2026-05-26T16:18:14.101Z
...
- Scanned artifacts: 173
- Ignored derived artifacts: 5
- Measured rows recognized: 899
- Aggregate rows recognized: 99
- 1 GiB+ JS full-string rows recognized: 563
- 1 GiB+ JS full-string aggregate rows recognized: 77
- Rows with recognized source mode: 322
- 1 GiB+ JS full-string rows with recognized source mode: 233
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 899 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:178, file-backed-sync-iterable-byte-batches:47, web-readable-stream-pull:4, sync-iterable-byte-batches:3, complete-js-string:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:178/178, file-backed-sync-iterable-byte-batches:47/47, web-readable-stream-pull:4/4, sync-iterable-byte-batches:3/3, complete-js-string:1/1.
