...
Generated: 2026-05-26T05:55:03.482Z
...
- Scanned artifacts: 153
- Ignored derived artifacts: 5
- Measured rows recognized: 808
- Aggregate rows recognized: 89
- 1 GiB+ JS full-string rows recognized: 502
- 1 GiB+ JS full-string aggregate rows recognized: 69
- Rows with recognized source mode: 231
- 1 GiB+ JS full-string rows with recognized source mode: 172
...
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: |
| `generated-sync-iterable-byte-batches` | 124 | 124 | 115 | 185.50 | Node/V8 rawFrameNameId from text-trim-cost-decomposition.json | 124 | 0 | 124 |
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 808 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:124, file-backed-sync-iterable-byte-batches:45, complete-js-string:1, sync-iterable-byte-batches:1, web-readable-stream-pull:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:124/124, file-backed-sync-iterable-byte-batches:45/45, complete-js-string:1/1, sync-iterable-byte-batches:1/1, web-readable-stream-pull:1/1.
