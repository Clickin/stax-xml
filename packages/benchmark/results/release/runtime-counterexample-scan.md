...
Generated: 2026-05-26T12:25:14.448Z
...
- Scanned artifacts: 164
- Ignored derived artifacts: 5
- Measured rows recognized: 852
- Aggregate rows recognized: 93
- 1 GiB+ JS full-string rows recognized: 529
- 1 GiB+ JS full-string aggregate rows recognized: 73
- Rows with recognized source mode: 275
- 1 GiB+ JS full-string rows with recognized source mode: 199
...
- Text/CDATA materialization headroom rows: 10
...
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: |
| `generated-sync-iterable-byte-batches` | 149 | 149 | 140 | 185.50 | Node/V8 rawFrameNameId from text-trim-cost-decomposition.json | 149 | 0 | 0 | 149 |
...
- text-materialization-headroom (HEADROOM_EVIDENCE_PRESENT): 10 recognized 1 GiB+ near-full row(s) cross the threshold only after omitting text/CDATA string materialization.
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 852 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:149, file-backed-sync-iterable-byte-batches:47, complete-js-string:1, sync-iterable-byte-batches:1, web-readable-stream-pull:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:149/149, file-backed-sync-iterable-byte-batches:47/47, complete-js-string:1/1, sync-iterable-byte-batches:1/1, web-readable-stream-pull:1/1.
