...
Generated: 2026-05-26T19:35:31.475Z
...
- Scanned artifacts: 177
- Ignored derived artifacts: 5
- Measured rows recognized: 931
- Aggregate rows recognized: 99
- 1 GiB+ JS full-string rows recognized: 588
- 1 GiB+ JS full-string aggregate rows recognized: 77
- Rows with recognized source mode: 352
- 1 GiB+ JS full-string rows with recognized source mode: 258
...
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: |
| `generated-sync-iterable-byte-batches` | 180 | 180 | 171 | 185.50 | Node/V8 rawFrameNameId from text-trim-cost-decomposition.json | 180 | 0 | 0 | 180 |
...
| `async-iterable-byte-batches` | 12 | 12 | 12 | 76.20 | Node/V8 async-iterable-raw-frame-ascii-batch-8 from stream-source-consumption-shapes.json | 12 | 0 | 12 | 12 |
| `web-readable-stream-pull` | 12 | 12 | 12 | 76.87 | Node/V8 web-readable-stream-raw-frame-ascii-batch-8 from stream-source-consumption-shapes.json | 12 | 12 | 12 | 12 |
| `sync-iterable-byte-batches` | 3 | 3 | 3 | 75.36 | Node/V8 sync-iterable-byte-batches from stream-source-consumption-shapes.json | 3 | 0 | 0 | 3 |
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 931 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:180, file-backed-sync-iterable-byte-batches:50, async-iterable-byte-batches:12, web-readable-stream-pull:12, sync-iterable-byte-batches:3, complete-js-string:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:180/180, file-backed-sync-iterable-byte-batches:50/50, async-iterable-byte-batches:12/12, web-readable-stream-pull:12/12, sync-iterable-byte-batches:3/3, complete-js-string:1/1.
