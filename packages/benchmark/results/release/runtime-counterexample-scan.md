...
Generated: 2026-05-25T17:47:16.952Z
...
- Measured rows recognized: 759
- Aggregate rows recognized: 89
- 1 GiB+ JS full-string rows recognized: 468
- 1 GiB+ JS full-string aggregate rows recognized: 69
- Rows with recognized source mode: 184
- 1 GiB+ JS full-string rows with recognized source mode: 134
...
| `file-backed-sync-iterable-byte-batches` | 23 | 23 | 23 | 146.08 | Node/V8 stax-raw-frame-name-id stax-raw-frame-name-id-batch-4 from file-backed-batch-size-sweep.json | 23 | 0 |
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 759 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:108, file-backed-sync-iterable-byte-batches:23, complete-js-string:1, sync-iterable-byte-batches:1, web-readable-stream-pull:1.
