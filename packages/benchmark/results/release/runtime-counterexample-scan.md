...
Generated: 2026-05-25T22:46:20.637Z
...
- Measured rows recognized: 767
- Aggregate rows recognized: 89
- 1 GiB+ JS full-string rows recognized: 476
- 1 GiB+ JS full-string aggregate rows recognized: 69
- Rows with recognized source mode: 196
- 1 GiB+ JS full-string rows with recognized source mode: 146
...
| `file-backed-sync-iterable-byte-batches` | 35 | 35 | 34 | 151.70 | Node/V8 stax-raw-frame-name-id stax-raw-frame-name-id-chunk-32kib from file-backed-source-sweep.json | 35 | 0 |
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 767 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:108, file-backed-sync-iterable-byte-batches:35, complete-js-string:1, sync-iterable-byte-batches:1, web-readable-stream-pull:1.
