...
Generated: 2026-05-26T13:09:14.611Z
...
- Scanned artifacts: 167
- Ignored derived artifacts: 5
- Measured rows recognized: 865
- Aggregate rows recognized: 93
- 1 GiB+ JS full-string rows recognized: 539
- 1 GiB+ JS full-string aggregate rows recognized: 73
- Rows with recognized source mode: 288
- 1 GiB+ JS full-string rows with recognized source mode: 209
...
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: |
| `generated-sync-iterable-byte-batches` | 159 | 159 | 150 | 185.50 | Node/V8 rawFrameNameId from text-trim-cost-decomposition.json | 159 | 0 | 0 | 159 |
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 865 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:159, file-backed-sync-iterable-byte-batches:47, complete-js-string:1, sync-iterable-byte-batches:1, web-readable-stream-pull:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:159/159, file-backed-sync-iterable-byte-batches:47/47, complete-js-string:1/1, sync-iterable-byte-batches:1/1, web-readable-stream-pull:1/1.
