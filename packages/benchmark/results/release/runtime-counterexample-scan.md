...
Generated: 2026-05-26T16:33:39.851Z
...
- Scanned artifacts: 174
- Ignored derived artifacts: 5
- Measured rows recognized: 903
- Aggregate rows recognized: 99
- 1 GiB+ JS full-string rows recognized: 565
- 1 GiB+ JS full-string aggregate rows recognized: 77
- Rows with recognized source mode: 324
- 1 GiB+ JS full-string rows with recognized source mode: 235
...
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: |
| `generated-sync-iterable-byte-batches` | 178 | 178 | 169 | 185.50 | Node/V8 rawFrameNameId from text-trim-cost-decomposition.json | 178 | 0 | 0 | 178 |
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 903 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:178, file-backed-sync-iterable-byte-batches:49, web-readable-stream-pull:4, sync-iterable-byte-batches:3, complete-js-string:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:178/178, file-backed-sync-iterable-byte-batches:49/49, web-readable-stream-pull:4/4, sync-iterable-byte-batches:3/3, complete-js-string:1/1.
