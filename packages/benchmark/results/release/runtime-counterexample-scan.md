...
Generated: 2026-05-24T04:14:11.732Z
...
- Scanned artifacts: 61
- Ignored derived artifacts: 5
- Measured rows recognized: 348
- 1 GiB+ JS full-string rows recognized: 147
- Counterexamples found: 0
- Partial/projection threshold rows: 1
- Full-string rows without bounded-memory proof: 52
...
- unbounded-or-unknown-full-rows-not-counterexamples (LIMITED_EVIDENCE_PRESENT): 52 recognized 1 GiB+ full-string JavaScript row(s) lack bounded-memory proof and cannot close the counterexample rule.
