...
Generated: 2026-05-26T20:00:00.062Z
...
- Scanned artifacts: 178
- Ignored derived artifacts: 5
- Measured rows recognized: 934
- Aggregate rows recognized: 99
- 1 GiB+ JS full-string rows recognized: 591
- 1 GiB+ JS full-string aggregate rows recognized: 77
- Rows with recognized source mode: 355
- 1 GiB+ JS full-string rows with recognized source mode: 261
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 934 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:180, file-backed-sync-iterable-byte-batches:50, async-iterable-byte-batches:13, web-readable-stream-pull:13, sync-iterable-byte-batches:4, complete-js-string:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:180/180, file-backed-sync-iterable-byte-batches:50/50, async-iterable-byte-batches:13/13, web-readable-stream-pull:13/13, sync-iterable-byte-batches:4/4, complete-js-string:1/1.
