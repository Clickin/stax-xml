...
Generated: 2026-06-01T06:54:28.851Z
...
- Scanned artifacts: 215
- Ignored derived artifacts: 7
- Measured rows recognized: 1209
- Aggregate rows recognized: 170
- 1 GiB+ JS full-string rows recognized: 814
- 1 GiB+ JS full-string aggregate rows recognized: 133
- Rows with recognized source mode: 596
- 1 GiB+ JS full-string rows with recognized source mode: 440
...
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: |
| `generated-sync-iterable-byte-batches` | 348 | 348 | 339 | 185.50 | Node/V8 rawFrameNameId from text-trim-cost-decomposition.json | 348 | 0 | 0 | 348 |
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 1209 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 23 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:348, file-backed-sync-iterable-byte-batches:53, async-iterable-byte-batches:15, web-readable-stream-pull:15, sync-iterable-byte-batches:4, fetch-async-iterable-byte-batches:2, fetch-readable-stream-pull:2, complete-js-string:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:348/348, file-backed-sync-iterable-byte-batches:53/53, async-iterable-byte-batches:15/15, web-readable-stream-pull:15/15, sync-iterable-byte-batches:4/4, fetch-async-iterable-byte-batches:2/2, fetch-readable-stream-pull:2/2, complete-js-string:1/1.
