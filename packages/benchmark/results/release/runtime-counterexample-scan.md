...
Generated: 2026-05-26T06:13:42.445Z
...
- Scanned artifacts: 154
- Ignored derived artifacts: 5
- Measured rows recognized: 810
- Aggregate rows recognized: 89
- 1 GiB+ JS full-string rows recognized: 504
- 1 GiB+ JS full-string aggregate rows recognized: 69
- Rows with recognized source mode: 233
- 1 GiB+ JS full-string rows with recognized source mode: 174
...
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: |
| `generated-sync-iterable-byte-batches` | 126 | 126 | 117 | 185.50 | Node/V8 rawFrameNameId from text-trim-cost-decomposition.json | 126 | 0 | 126 |
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 810 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:126, file-backed-sync-iterable-byte-batches:45, complete-js-string:1, sync-iterable-byte-batches:1, web-readable-stream-pull:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:126/126, file-backed-sync-iterable-byte-batches:45/45, complete-js-string:1/1, sync-iterable-byte-batches:1/1, web-readable-stream-pull:1/1.
