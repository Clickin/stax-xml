...
Generated: 2026-05-24T04:49:37.527Z
...
- Scanned artifacts: 62
- Ignored derived artifacts: 5
- Measured rows recognized: 353
- 1 GiB+ JS full-string rows recognized: 150
- Counterexamples found: 0
- Partial/projection threshold rows: 1
- Full-string rows without bounded-memory proof: 55
...
- unbounded-or-unknown-full-rows-not-counterexamples (LIMITED_EVIDENCE_PRESENT): 55 recognized 1 GiB+ full-string JavaScript row(s) lack bounded-memory proof and cannot close the counterexample rule.
