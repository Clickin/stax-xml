...
Generated: 2026-05-24T16:50:38.555Z
...
- Scanned artifacts: 94
- Ignored derived artifacts: 5
- Measured rows recognized: 572
- 1 GiB+ JS full-string rows recognized: 327
- Counterexamples found: 0
- Partial/projection threshold rows: 12
- Full-string rows without bounded-memory proof: 95
...
- unbounded-or-unknown-full-rows-not-counterexamples (LIMITED_EVIDENCE_PRESENT): 95 recognized 1 GiB+ full-string JavaScript row(s) lack bounded-memory proof and cannot close the counterexample rule.
