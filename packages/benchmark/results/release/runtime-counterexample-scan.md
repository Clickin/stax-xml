...
Generated: 2026-05-26T15:55:21.906Z
...
- Scanned artifacts: 172
- Ignored derived artifacts: 5
- Measured rows recognized: 895
- Aggregate rows recognized: 99
- 1 GiB+ JS full-string rows recognized: 560
- 1 GiB+ JS full-string aggregate rows recognized: 77
- Rows with recognized source mode: 318
- 1 GiB+ JS full-string rows with recognized source mode: 230
...
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: |
| `generated-sync-iterable-byte-batches` | 175 | 175 | 166 | 185.50 | Node/V8 rawFrameNameId from text-trim-cost-decomposition.json | 175 | 0 | 0 | 175 |
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 895 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:175, file-backed-sync-iterable-byte-batches:47, web-readable-stream-pull:4, sync-iterable-byte-batches:3, complete-js-string:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:175/175, file-backed-sync-iterable-byte-batches:47/47, web-readable-stream-pull:4/4, sync-iterable-byte-batches:3/3, complete-js-string:1/1.
