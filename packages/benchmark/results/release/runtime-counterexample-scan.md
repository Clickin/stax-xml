...
Generated: 2026-05-26T15:08:28.764Z
...
- Measured rows recognized: 877
- Aggregate rows recognized: 93
- 1 GiB+ JS full-string rows recognized: 548
- 1 GiB+ JS full-string aggregate rows recognized: 73
- Rows with recognized source mode: 300
- 1 GiB+ JS full-string rows with recognized source mode: 218
...
| `web-readable-stream-pull` | 4 | 4 | 4 | 74.26 | Node/V8 web-readable-stream-pull-batch-8 from stream-source-consumption-shapes.json | 4 | 4 | 4 | 4 |
| `sync-iterable-byte-batches` | 3 | 3 | 3 | 75.31 | Node/V8 sync-iterable-byte-batches from stream-source-consumption-shapes.json | 3 | 0 | 0 | 3 |
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 877 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:163, file-backed-sync-iterable-byte-batches:47, web-readable-stream-pull:4, sync-iterable-byte-batches:3, complete-js-string:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:163/163, file-backed-sync-iterable-byte-batches:47/47, web-readable-stream-pull:4/4, sync-iterable-byte-batches:3/3, complete-js-string:1/1.
