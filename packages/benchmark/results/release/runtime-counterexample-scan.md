...
Generated: 2026-05-26T14:35:37.260Z
...
- Scanned artifacts: 168
- Ignored derived artifacts: 5
- Measured rows recognized: 874
- Aggregate rows recognized: 93
- 1 GiB+ JS full-string rows recognized: 545
- 1 GiB+ JS full-string aggregate rows recognized: 73
- Rows with recognized source mode: 297
- 1 GiB+ JS full-string rows with recognized source mode: 215
...
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: |
| `generated-sync-iterable-byte-batches` | 163 | 163 | 154 | 185.50 | Node/V8 rawFrameNameId from text-trim-cost-decomposition.json | 163 | 0 | 0 | 163 |
...
| `sync-iterable-byte-batches` | 3 | 3 | 3 | 128.29 | Node/V8 sync-iterable-byte-batches-batch-8 from stream-source-consumption-shapes.json | 3 | 0 | 0 | 3 |
| `complete-js-string` | 1 | 1 | 0 | 41.10 | Bun/JSC 3 from bun-event-reader-string-large.json | 0 | 0 | 0 | 1 |
| `web-readable-stream-pull` | 1 | 1 | 1 | 125.22 | Node/V8 web-readable-stream-pull from stream-source-consumption-shapes.json | 1 | 1 | 1 | 1 |
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 874 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:163, file-backed-sync-iterable-byte-batches:47, sync-iterable-byte-batches:3, complete-js-string:1, web-readable-stream-pull:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:163/163, file-backed-sync-iterable-byte-batches:47/47, sync-iterable-byte-batches:3/3, complete-js-string:1/1, web-readable-stream-pull:1/1.
