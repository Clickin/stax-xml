...
Generated: 2026-05-25T23:01:30.106Z
...
- Scanned artifacts: 140
- Ignored derived artifacts: 5
- Measured rows recognized: 771
- Aggregate rows recognized: 89
- 1 GiB+ JS full-string rows recognized: 478
- 1 GiB+ JS full-string aggregate rows recognized: 69
- Rows with recognized source mode: 198
- 1 GiB+ JS full-string rows with recognized source mode: 148
...
| `file-backed-sync-iterable-byte-batches` | 37 | 37 | 36 | 151.70 | Node/V8 stax-raw-frame-name-id stax-raw-frame-name-id-chunk-32kib from file-backed-source-sweep.json | 37 | 0 |
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 771 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:108, file-backed-sync-iterable-byte-batches:37, complete-js-string:1, sync-iterable-byte-batches:1, web-readable-stream-pull:1.
