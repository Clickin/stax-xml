...
Generated: 2026-05-26T18:27:05.631Z
...
- Measured rows recognized: 927
- Aggregate rows recognized: 99
- 1 GiB+ JS full-string rows recognized: 586
- 1 GiB+ JS full-string aggregate rows recognized: 77
- Rows with recognized source mode: 348
- 1 GiB+ JS full-string rows with recognized source mode: 256
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 927 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:179, file-backed-sync-iterable-byte-batches:49, async-iterable-byte-batches:12, web-readable-stream-pull:12, sync-iterable-byte-batches:3, complete-js-string:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:179/179, file-backed-sync-iterable-byte-batches:49/49, async-iterable-byte-batches:12/12, web-readable-stream-pull:12/12, sync-iterable-byte-batches:3/3, complete-js-string:1/1.
