...
Generated: 2026-05-24T01:50:40.426Z
...
- Scanned artifacts: 59
- Ignored derived artifacts: 4
- Measured rows recognized: 342
- 1 GiB+ JS full-string rows recognized: 141
- Counterexamples found: 0
- Partial/projection threshold rows: 1
- Full-string rows without bounded-memory proof: 46
...
- unbounded-or-unknown-full-rows-not-counterexamples (LIMITED_EVIDENCE_PRESENT): 46 recognized 1 GiB+ full-string JavaScript row(s) lack bounded-memory proof and cannot close the counterexample rule.
