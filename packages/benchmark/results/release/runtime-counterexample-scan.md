...
Generated: 2026-05-26T01:52:37.329Z
...
- Measured rows recognized: 784
- Aggregate rows recognized: 89
- 1 GiB+ JS full-string rows recognized: 486
- 1 GiB+ JS full-string aggregate rows recognized: 69
- Rows with recognized source mode: 207
- 1 GiB+ JS full-string rows with recognized source mode: 156
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 784 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:108, file-backed-sync-iterable-byte-batches:45, complete-js-string:1, sync-iterable-byte-batches:1, web-readable-stream-pull:1.
