...
Generated: 2026-05-31T14:56:45.150Z
...
- Scanned artifacts: 184
- Ignored derived artifacts: 6
- Measured rows recognized: 1006
- Aggregate rows recognized: 117
- 1 GiB+ JS full-string rows recognized: 660
- 1 GiB+ JS full-string aggregate rows recognized: 95
- Rows with recognized source mode: 408
- 1 GiB+ JS full-string rows with recognized source mode: 301
...
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: |
| `generated-sync-iterable-byte-batches` | 209 | 209 | 200 | 185.50 | Node/V8 rawFrameNameId from text-trim-cost-decomposition.json | 209 | 0 | 0 | 209 |
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 1006 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:209, file-backed-sync-iterable-byte-batches:53, async-iterable-byte-batches:15, web-readable-stream-pull:15, sync-iterable-byte-batches:4, fetch-async-iterable-byte-batches:2, fetch-readable-stream-pull:2, complete-js-string:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:209/209, file-backed-sync-iterable-byte-batches:53/53, async-iterable-byte-batches:15/15, web-readable-stream-pull:15/15, sync-iterable-byte-batches:4/4, fetch-async-iterable-byte-batches:2/2, fetch-readable-stream-pull:2/2, complete-js-string:1/1.
