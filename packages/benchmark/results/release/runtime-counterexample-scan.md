...
Generated: 2026-05-27T01:06:12.375Z
...
- Measured rows recognized: 995
- Aggregate rows recognized: 117
- 1 GiB+ JS full-string rows recognized: 652
- 1 GiB+ JS full-string aggregate rows recognized: 95
- Rows with recognized source mode: 380
- 1 GiB+ JS full-string rows with recognized source mode: 286
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 995 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:196, file-backed-sync-iterable-byte-batches:53, async-iterable-byte-batches:15, web-readable-stream-pull:15, sync-iterable-byte-batches:4, complete-js-string:1, fetch-async-iterable-byte-batches:1, fetch-readable-stream-pull:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:196/196, file-backed-sync-iterable-byte-batches:53/53, async-iterable-byte-batches:15/15, web-readable-stream-pull:15/15, sync-iterable-byte-batches:4/4, complete-js-string:1/1, fetch-async-iterable-byte-batches:1/1, fetch-readable-stream-pull:1/1.
