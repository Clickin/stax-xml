...
Generated: 2026-05-24T03:57:09.983Z
...
- Scanned artifacts: 60
- Ignored derived artifacts: 5
- Measured rows recognized: 345
- 1 GiB+ JS full-string rows recognized: 144
- Counterexamples found: 0
- Partial/projection threshold rows: 1
- Full-string rows without bounded-memory proof: 49
...
- unbounded-or-unknown-full-rows-not-counterexamples (LIMITED_EVIDENCE_PRESENT): 49 recognized 1 GiB+ full-string JavaScript row(s) lack bounded-memory proof and cannot close the counterexample rule.
