...
Generated: 2026-05-26T23:13:23.242Z
...
- Scanned artifacts: 182
- Ignored derived artifacts: 5
- Measured rows recognized: 991
- Aggregate rows recognized: 117
- 1 GiB+ JS full-string rows recognized: 648
- 1 GiB+ JS full-string aggregate rows recognized: 95
- Rows with recognized source mode: 376
- 1 GiB+ JS full-string rows with recognized source mode: 282
...
- Partial/projection threshold rows: 38
...
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: |
| `generated-sync-iterable-byte-batches` | 196 | 196 | 187 | 185.50 | Node/V8 rawFrameNameId from text-trim-cost-decomposition.json | 196 | 0 | 0 | 196 |
...
| `async-iterable-byte-batches` | 13 | 13 | 13 | 76.20 | Node/V8 async-iterable-raw-frame-ascii-batch-8 from stream-source-consumption-shapes.json | 13 | 0 | 13 | 13 |
| `web-readable-stream-pull` | 13 | 13 | 13 | 76.87 | Node/V8 web-readable-stream-raw-frame-ascii-batch-8 from stream-source-consumption-shapes.json | 13 | 13 | 13 | 13 |
| `sync-iterable-byte-batches` | 4 | 4 | 4 | 90.56 | Node/V8 sync-iterable-byte-batches-batch-8 from stream-source-consumption-backpressure-counters.json | 4 | 0 | 0 | 4 |
| `complete-js-string` | 1 | 1 | 0 | 41.10 | Bun/JSC 3 from bun-event-reader-string-large.json | 0 | 0 | 0 | 1 |
| `fetch-async-iterable-byte-batches` | 1 | 1 | 1 | 9.77 | Chrome/V8 fetchAsyncByteBatchFull from browser-fetch-readable-stream-books-corpus.json | 1 | 0 | 1 | 1 |
| `fetch-readable-stream-pull` | 1 | 1 | 1 | 9.68 | Chrome/V8 fetchReadableStreamFull from browser-fetch-readable-stream-books-corpus.json | 1 | 1 | 1 | 1 |
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 991 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:196, file-backed-sync-iterable-byte-batches:53, async-iterable-byte-batches:13, web-readable-stream-pull:13, sync-iterable-byte-batches:4, complete-js-string:1, fetch-async-iterable-byte-batches:1, fetch-readable-stream-pull:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:196/196, file-backed-sync-iterable-byte-batches:53/53, async-iterable-byte-batches:13/13, web-readable-stream-pull:13/13, sync-iterable-byte-batches:4/4, complete-js-string:1/1, fetch-async-iterable-byte-batches:1/1, fetch-readable-stream-pull:1/1.
