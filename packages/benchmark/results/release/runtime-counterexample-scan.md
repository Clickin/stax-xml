...
Generated: 2026-05-25T22:38:08.781Z
...
- Rows with recognized source mode: 192
- 1 GiB+ JS full-string rows with recognized source mode: 142
...
| `file-backed-sync-iterable-byte-batches` | 31 | 31 | 31 | 151.70 | Node/V8 stax-raw-frame-name-id stax-raw-frame-name-id-chunk-32kib from file-backed-source-sweep.json | 31 | 0 |
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:108, file-backed-sync-iterable-byte-batches:31, complete-js-string:1, sync-iterable-byte-batches:1, web-readable-stream-pull:1.
