...
Generated: 2026-05-26T17:07:30.345Z
...
- Measured rows recognized: 907
- Aggregate rows recognized: 99
- 1 GiB+ JS full-string rows recognized: 566
- 1 GiB+ JS full-string aggregate rows recognized: 77
- Rows with recognized source mode: 328
- 1 GiB+ JS full-string rows with recognized source mode: 236
...
- measured-row-classification-complete (LIMITED_EVIDENCE_PRESENT): 907 recognized measured row(s) include fullStringParity and boundedMemory classifications; 0 have unknown fullStringParity and 20 have unknown boundedMemory.
...
- source-consumption-modes-separated (SOURCE_MODE_EVIDENCE_PRESENT): Recognized 1 GiB+ full-string rows expose source-mode metadata for generated-sync-iterable-byte-batches:179, file-backed-sync-iterable-byte-batches:49, web-readable-stream-pull:4, sync-iterable-byte-batches:3, complete-js-string:1; not-full-ArrayBuffer parser-input rows are generated-sync-iterable-byte-batches:179/179, file-backed-sync-iterable-byte-batches:49/49, web-readable-stream-pull:4/4, sync-iterable-byte-batches:3/3, complete-js-string:1/1.
