...
Generated: 2026-05-25T06:54:03.486Z
...
- Batch size: 1
- Cases: stringFull, rawFrameNameId, rawFrameNameIdLongAsciiText, withoutTextStrings
...
| --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | --- | ---: | ---: | --- |
| stringFull | full-stax-js | full-string-materialization | stream-events | 148.17 MiB/s | 1.00x | 0.44x | below | yes | not-found | 57096514 | -540013997 | yes |
| rawFrameNameId | full-stax-js | full-string-materialization | stream-events | 172.85 MiB/s | 1.17x | 0.52x | below | yes | not-found | 57096514 | -540013997 | yes |
| rawFrameNameIdLongAsciiText | full-stax-js | full-string-materialization | stream-events | 71.21 MiB/s | 0.48x | 0.21x | below | yes | not-found | 57096514 | -540013997 | yes |
| withoutTextStrings | near-full-upper-bound | full-materialization-minus-text-cdata | stream-events | 207.70 MiB/s | 1.40x | 0.62x | not-applicable | yes | not-found | 57096514 | 1372281363 | no |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| stringFull | 3 | 6911.09 | 6160.95 | 8260.48 | 30.4% | 6311.85, 8260.48, 6160.95 |
| rawFrameNameId | 3 | 5924.22 | 5896.31 | 5942.19 | 0.8% | 5934.16, 5942.19, 5896.31 |
| rawFrameNameIdLongAsciiText | 3 | 14380.04 | 13857.56 | 15004.90 | 8.0% | 14277.66, 15004.90, 13857.56 |
| withoutTextStrings | 3 | 4930.21 | 4379.70 | 5674.08 | 26.3% | 4379.70, 4736.85, 5674.08 |
...
| --- | ---: | ---: | ---: | ---: |
| stringFull | +1.7 MiB | +2.3 MiB | 7.1 MiB | 71.4 MiB |
| rawFrameNameId | +1.8 MiB | +2.2 MiB | 7.7 MiB | 78.0 MiB |
| rawFrameNameIdLongAsciiText | +9.0 MiB | +8.0 MiB | 20.5 MiB | 102.1 MiB |
| withoutTextStrings | +6.0 MiB | +6.4 MiB | 11.3 MiB | 121.4 MiB |
...
Full-string parity rows: ok, events=57096514, checksum=-540013997, rows=stringFull, rawFrameNameId, rawFrameNameIdLongAsciiText.
...
- bounded-memory-contract: Rows consume corpus-backed Uint8Array batches and do not load a full XML string.
  - stringFull: maxRSS=71.4 MiB
  - rawFrameNameId: maxRSS=78.0 MiB
  - rawFrameNameIdLongAsciiText: maxRSS=102.1 MiB
...
- headroom-search: The fastest row in each family is a headroom signal, not a runtime-limit conclusion.
  - partial=withoutTextStrings 207.70 MiB/s
  - full=rawFrameNameId 172.85 MiB/s
- long-ascii-text-materialization-candidate: rawFrameNameIdLongAsciiText keeps the full-string checksum while replacing TextDecoder on ASCII text/CDATA spans longer than the short-span fast path.
  - rawFrameNameId=172.85 MiB/s
  - rawFrameNameIdLongAsciiText=71.21 MiB/s
  - sameChecksum=true
