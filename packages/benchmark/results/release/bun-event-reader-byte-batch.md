...
Generated: 2026-06-01T06:22:54.232Z
...
| --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| readableStreamBatch1 | readable-stream | web-readable-stream-pull | ReadableStream<Uint8Array> | yes | yes | yes | 1 | 14.28 MiB/s | 46195346 | -577171566 | 5774419 | 5774418 | yes | 232.5 MiB |
| readableStreamBatch16 | readable-stream | web-readable-stream-pull | ReadableStream<Uint8Array> | yes | yes | yes | 16 | 17.06 MiB/s | 46195346 | -577171566 | 5774419 | 5774418 | yes | 189.5 MiB |
| readableStreamBatch64 | readable-stream | web-readable-stream-pull | ReadableStream<Uint8Array> | yes | yes | yes | 64 | 18.75 MiB/s | 46195346 | -577171566 | 5774419 | 5774418 | yes | 189.2 MiB |
| asyncByteBatch16 | async-byte-batch | async-iterable-byte-batches | AsyncIterable<Uint8Array[]> | no | yes | yes | 16 | 18.89 MiB/s | 46195346 | -577171566 | 5774418 | 360902 | yes | 189.7 MiB |
| asyncByteBatch64 | async-byte-batch | async-iterable-byte-batches | AsyncIterable<Uint8Array[]> | no | yes | yes | 64 | 20.44 MiB/s | 46195346 | -577171566 | 5774418 | 90226 | yes | 190.5 MiB |
| syncIterableBatch1 | sync-iterable-byte-batch | sync-iterable-byte-batches | Iterable<Uint8Array[]> | no | no | yes | 1 | 24.78 MiB/s | 46195346 | -577171566 | 5774418 | 5774418 | yes | 219.5 MiB |
| syncIterableBatch16 | sync-iterable-byte-batch | sync-iterable-byte-batches | Iterable<Uint8Array[]> | no | no | yes | 16 | 29.41 MiB/s | 46195346 | -577171566 | 5774418 | 360902 | yes | 211.9 MiB |
| syncIterableBatch64 | sync-iterable-byte-batch | sync-iterable-byte-batches | Iterable<Uint8Array[]> | no | no | yes | 64 | 30.73 MiB/s | 46195346 | -577171566 | 5774418 | 90226 | yes | 211.9 MiB |
...
- fixture-cycle-source-scope (SOURCE_FACT): The benchmark isolates parser/source API overhead by replaying prepared fixture rows, not by streaming the full target size from OS, network, or browser fetch.
  ...
  - fileBackedRows=none
- async-byte-batch-headroom (BENCH_FACT): At batch size 16, async byte batches were 1.11x the ReadableStream row on this run; this row avoids direct ReadableStream consumption but still crosses an AsyncIterator source boundary.
  - readableStreamBatch16=17.06 MiB/s
  - asyncByteBatch16=18.89 MiB/s
- sync-iterable-byte-batch-headroom (BENCH_FACT): At batch size 16, sync iterable byte batches were 1.72x the ReadableStream row on this run; this is the row that removes the ReadableStream and AsyncIterator source boundary while preserving demand-driven pulls.
  - readableStreamBatch16=17.06 MiB/s
  - syncIterableBatch16=29.41 MiB/s
