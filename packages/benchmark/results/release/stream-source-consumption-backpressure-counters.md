...
Generated: 2026-05-26T19:59:37.619Z
...
- Fastest row: sync-iterable-byte-batches-batch-8 90.56 MiB/s, RSS 130.48 MiB
- Fastest sync Iterable row: sync-iterable-byte-batches-batch-8 90.56 MiB/s, RSS 130.48 MiB
- Fastest async Iterable row: async-iterable-byte-batches-batch-8 67.12 MiB/s, RSS 74.37 MiB
- Fastest ReadableStream row: web-readable-stream-pull-batch-8 72.69 MiB/s, RSS 72.94 MiB
- Async Iterable / batch-1 sync Iterable ratio: n/ax
- Fastest async Iterable / fastest sync Iterable ratio: 0.74x
- ReadableStream / batch-1 sync Iterable ratio: n/ax
- ReadableStream / fastest sync Iterable ratio: n/ax
- Fastest ReadableStream / fastest sync Iterable ratio: 0.80x
...
| --- | --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `sync-iterable-byte-batches-batch-8` | Node + stax-xml StreamReaderSync over demand-driven Iterable<Uint8Array[]> file batches (batchSize=8) | 8 | 90.56 | 1 | 0.0% | yes | 130.48 MiB | 61236571 | -716099804 | 16385 | 2048 | 0 | yes | n/a |
| `async-iterable-byte-batches-batch-8` | Node + stax-xml StreamReader over demand-driven AsyncIterable<Uint8Array[]> file batches (batchSize=8) | 8 | 67.12 | 1 | 0.0% | yes | 74.37 MiB | 61236571 | -716099804 | 16385 | 2048 | 0 | yes | yes |
| `web-readable-stream-pull-batch-8` | Node + stax-xml StreamReader over backpressure-respecting ReadableStream<Uint8Array> pull source (batchSize=8) | 8 | 72.69 | 1 | 0.0% | yes | 72.94 MiB | 61236571 | -716099804 | 16385 | 0 | 16385 | yes | yes |
...
- current-release-source-shape (CONTRACT_FACT): The current file-backed release comparison uses the sync Iterable<Uint8Array[]> shape, not direct Web ReadableStream consumption; grouped sync rows remain demand-driven parser pulls.
  - sync-iterable-byte-batches-batch-8: batchSize=8, 90.56 MiB/s
- sync-batch-size-headroom (BENCH_FACT): The fastest sync Iterable<Uint8Array[]> row was sync-iterable-byte-batches-batch-8 at 90.56 MiB/s; this isolates grouped byte-batch source shape from direct ReadableStream async overhead.
  - sync-iterable-byte-batches-batch-8: batchSize=8, rss=130.48 MiB, checksum=-716099804
- async-byte-batch-source-shape (BENCH_FACT): The fastest AsyncIterable<Uint8Array[]> row was async-iterable-byte-batches-batch-8 at 67.12 MiB/s (0.74x of the fastest sync row); this isolates an async batch boundary without direct ReadableStream reads.
  - async-iterable-byte-batches-batch-8: batchSize=8, rss=74.37 MiB, checksum=-716099804
- async-raw-frame-source-shape (BENCH_FACT): No AsyncIterable nextRawBatch rows were measured.
- readable-stream-direct-source-shape (BENCH_FACT): Direct ReadableStream consumption reached 72.69 MiB/s (0.80x of the fastest sync Iterable<Uint8Array[]> row); this is a separate source-shape row, not the current release comparison source.
  - sync-iterable-byte-batches-batch-8=90.56 MiB/s rss=130.48 MiB
  - async-iterable-byte-batches-batch-8=67.12 MiB/s rss=74.37 MiB
  - web-readable-stream-pull-batch-8=72.69 MiB/s rss=72.94 MiB
- readable-stream-batch-size-headroom (BENCH_FACT): The fastest bounded ReadableStream batch row was web-readable-stream-pull-batch-8 at 72.69 MiB/s; this tests whether grouping chunks behind the ReadableStream async boundary exposes headroom.
  - web-readable-stream-pull-batch-8: batchSize=8, rss=72.94 MiB, checksum=-716099804
- readable-stream-raw-frame-source-shape (BENCH_FACT): No ReadableStream nextRawBatch rows were measured.
