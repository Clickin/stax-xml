...
Generated: 2026-05-25T07:07:50.163Z
...
| --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | --- | ---: | ---: | --- |
| rawFrameNameId | full-stax-js | full-string-materialization | stream-events | 175.02 MiB/s | 1.00x | 0.52x | below | yes | not-found | 57096514 | -540013997 | yes |
| rawFrameNameIdTextCache | full-stax-js | full-string-materialization | stream-events | 129.31 MiB/s | 1.00x | 0.39x | below | yes | not-found | 57096514 | -540013997 | yes |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| rawFrameNameId | 3 | 5850.86 | 5679.24 | 5980.28 | 5.1% | 5893.06, 5980.28, 5679.24 |
| rawFrameNameIdTextCache | 3 | 7919.15 | 7808.92 | 8056.59 | 3.1% | 7891.94, 7808.92, 8056.59 |
...
| --- | ---: | ---: | ---: | ---: |
| rawFrameNameId | +1.5 MiB | +2.1 MiB | 7.0 MiB | 71.2 MiB |
| rawFrameNameIdTextCache | +2.1 MiB | +2.0 MiB | 8.4 MiB | 77.4 MiB |
...
Full-string parity rows: ok, events=57096514, checksum=-540013997, rows=rawFrameNameId, rawFrameNameIdTextCache.
...
- bounded-memory-contract: Rows consume corpus-backed Uint8Array batches and do not load a full XML string.
  ...
  - rawFrameNameIdTextCache: maxRSS=77.4 MiB
...
- headroom-search: The fastest row in each family is a headroom signal, not a runtime-limit conclusion.
  - partial=missing
  - full=rawFrameNameId 175.02 MiB/s
- text-only-cache-candidate: rawFrameNameIdTextCache keeps the full-string checksum while caching only text/CDATA span strings; attribute values still use direct TextDecoder materialization.
  - rawFrameNameId=175.02 MiB/s
  - rawFrameNameIdTextCache=129.31 MiB/s
  - sameChecksum=true
