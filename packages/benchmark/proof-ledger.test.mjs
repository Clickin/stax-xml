...
test('proof ledger keeps runtime-limit claims below conclusion strength', () => {
  ...
  assert.match(markdown, /recognizes 624\s+measured rows/);
  ...
  assert.match(markdown, /recognizes 624\s+measured rows/);
  assert.match(markdown, /73 benchmark artifacts, 13 source artifacts, 7\s+trace\/profile artifacts, 13 allocation artifacts, 2 environment artifacts, and\s+4 negative-result artifacts/);
