...
test('proof ledger keeps runtime-limit claims below conclusion strength', () => {
  ...
  assert.match(markdown, /450 JavaScript 1 GiB\+ full-string rows and zero\s+bounded-memory 200 MiB\/s\+ counterexamples/);
  assert.match(markdown, /Bun\/JSC `rawFrameNameId` fresh-process sample from\s+`access-shape-candidate-cross-process\.json` at 179\.70 MiB\/s/);
