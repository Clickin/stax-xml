...
test('proof ledger keeps runtime-limit claims below conclusion strength', () => {
  ...
  assert.match(markdown, /recognizes 995\s+sample throughput rows and 117 aggregate rows/);
  ...
  assert.match(markdown, /652 JavaScript 1 GiB\+\s+full-string sample rows plus 95 JavaScript 1 GiB\+ full-string aggregate rows/);
  ...
  assert.match(markdown, /286 JavaScript 1 GiB\+\s+full-string rows with source mode metadata/);
  ...
  assert.match(markdown, /all 286\s+JavaScript 1 GiB\+ full-string rows with source-mode metadata are now marked as\s+not full `ArrayBuffer` parser-input rows/);
  ...
  assert.match(markdown, /recognizes 995\s+measured rows/);
  assert.match(markdown, /134 benchmark artifacts, 18 source artifacts, 10\s+trace\/profile artifacts, 15 allocation artifacts, 4 environment artifacts, and\s+19 negative-result artifacts, 652 JavaScript 1 GiB\+ full-string rows/);
