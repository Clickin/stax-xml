...
test('proof ledger keeps runtime-limit claims below conclusion strength', () => {
  ...
  assert.match(markdown, /`segment-tokenizer-headroom\.json` then raises that same\s+source-shape question from delimiter scanning to XML token-boundary folding/);
