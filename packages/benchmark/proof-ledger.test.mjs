...
test('proof ledger keeps runtime-limit claims below conclusion strength', () => {
  ...
  assert.match(markdown, /unknown bounded-memory set contains 55 JavaScript rows, 62\s+full-string rows, 40 JavaScript full-string rows, 0 JavaScript 1 GiB\+\s+full-string rows, and 24 rows that have raw memory counters/);
