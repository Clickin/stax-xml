...
test('proof ledger keeps runtime-limit claims below conclusion strength', () => {
  ...
  assert.match(markdown, /recognizes 991\s+sample throughput rows and 117 aggregate rows/);
  ...
  assert.match(markdown, /648 JavaScript 1 GiB\+\s+full-string sample rows plus 95 JavaScript 1 GiB\+ full-string aggregate rows/);
