...
test('proof ledger keeps runtime-limit claims below conclusion strength', () => {
  ...
  assert.match(markdown, /recognizes 827\s+sample throughput rows and 93 aggregate rows/);
  ...
  assert.match(markdown, /recognizes 813\s+measured rows/);
  assert.match(markdown, /113 benchmark artifacts, 16 source artifacts, 10\s+trace\/profile artifacts, 15 allocation artifacts, 2 environment artifacts, and\s+12 negative-result artifacts/);
