...
test('proof ledger keeps runtime-limit claims below conclusion strength', () => {
  ...
  assert.match(markdown, /159 aggregated rows and 142 JavaScript 1 GiB\+\s+full-string rows/);
  ...
  assert.match(markdown, /all 136 JavaScript 1 GiB\+ full-string\s+rows with source-mode metadata in this aggregate are marked as not full\s+`ArrayBuffer` parser-input rows/);
  ...
  assert.match(markdown, /recognizes 841\s+sample throughput rows and 93 aggregate rows/);
  ...
  assert.match(markdown, /recognizes 841\s+measured rows/);
