...
const negativeArtifacts = [
  ...
  },
  {
    ...
    family: 'node-no-counter-name-fold-cache-fresh-process',
  },
  {
    file: 'no-counter-materialization-batch1-cross-runtime-books-corpus.json',
    runtime: 'node',
    ...
    family: 'node-no-counter-string-fold-cache-fresh-process',
  },
  {
    file: 'no-counter-materialization-batch1-cross-runtime-books-corpus.json',
    runtime: 'bun',
    controlId: 'rawFrameNameId',
    candidateId: 'rawFrameNameIdNoCountersNameFoldCache',
    family: 'bun-no-counter-name-fold-cache-fresh-process',
  },
  {
    file: 'no-counter-materialization-batch1-cross-runtime-books-corpus.json',
    runtime: 'bun',
    controlId: 'rawFrameNameId',
    candidateId: 'rawFrameNameIdNoCountersStringFoldCache',
    family: 'bun-no-counter-string-fold-cache-fresh-process',
  },
  {
    file: 'no-counter-materialization-batch1-cross-runtime-books-corpus.json',
    runtime: 'deno',
    controlId: 'rawFrameNameId',
    candidateId: 'rawFrameNameIdNoCountersNameFoldCache',
    family: 'deno-no-counter-name-fold-cache-fresh-process',
  },
  {
    file: 'no-counter-materialization-batch1-cross-runtime-books-corpus.json',
    runtime: 'deno',
  ...
  },
  {
    ...
    family: 'unrolled-medium-ascii-text-trim-guard',
  },
  {
