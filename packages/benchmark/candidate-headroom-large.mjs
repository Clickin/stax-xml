...
function createReport(fixture, options, variants) {
  ...
  return {
    ...
    contract: 'generated-byte-batch-mixed-materialization-headroom-matrix',
    note: 'This is a 1 GiB+ bounded-memory counterexample search for generated byte batches. Partial rows are upper-bound probes only; full rows keep the StAX-like checksum contract.',
    packageVersion,
    environment: createRuntimeEnvironment(),
    fixture: {
      generated: true,
      shape: fixture.fixtureShape,
      rowXml: textDecoder.decode(fixture.rows[0]),
    ...
    omittedRows: [
      {
        id: 'eventObjectFull',
        reason: 'EventReaderSync requires a complete XML string input in this benchmark family, so it is excluded from the generated byte-batch bounded-memory matrix.',
      },
      {
  ...
  return [
    {
      ...
      summary: 'Rows consume generated Uint8Array batches and do not load a full XML string.',
