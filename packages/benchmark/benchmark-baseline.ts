...
class GCMonitor {
  private gcEvents: Array<{ kind: string; duration: number }> = [];
  private heapBefore: ReturnType<typeof v8.getHeapStatistics>;
...
function parseXML(xml: string): number {
...
async function benchmarkFile(testFile: string, iterations: number = 100): Promise<BenchResult> {
