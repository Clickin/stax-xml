...
interface ComparisonResult {
  baseline: QuickBenchmarkResult;
  stringArray: QuickBenchmarkResult;
  uint8Array: QuickBenchmarkResult;
  speedupStringArray: number; // multiplier
  speedupUint8Array: number; // multiplier
  improvementStringArray: number; // percentage
  improvementUint8Array: number; // percentage
 ...
 */
function runQuickBenchmark(): ComparisonResult {
