...
const variantArtifacts = [
  ...
  {
    group: 'no-counter-materialization-negative',
    file: 'no-counter-materialization-candidate.json',
    runtimeId: 'node-v8',
    runtimeLabel: 'Node/V8',
    jsRuntime: true,
    cases: [
  ...
  {
    group: 'no-counter-materialization-batch1-negative',
    file: 'no-counter-materialization-batch1-candidate.json',
    runtimeId: 'node-v8',
    runtimeLabel: 'Node/V8',
    jsRuntime: true,
    cases: [
