    ...
    handoffs.push({
      ...
      commands: [
        ...
        },
        {
          ...
          command: 'node packages/benchmark/same-contract-runtime-comparison.mjs --json-out packages/benchmark/results/release/same-contract-runtime-comparison.json --md-out packages/benchmark/results/release/same-contract-runtime-comparison.md && node packages/benchmark/safari-webkit-closure-audit.mjs --json-out packages/benchmark/results/release/safari-webkit-closure-audit.json --md-out packages/benchmark/results/release/safari-webkit-closure-audit.md && node packages/benchmark/runtime-counterexample-scan.mjs --json-out packages/benchmark/results/release/runtime-counterexample-scan.json --md-out packages/benchmark/results/release/runtime-counterexample-scan.md && node packages/benchmark/runtime-proof-coverage-audit.mjs --json-out packages/benchmark/results/release/runtime-proof-coverage-audit.json --md-out packages/benchmark/results/release/runtime-proof-coverage-audit.md && node packages/benchmark/source-consumption-shape-audit.mjs --json-out packages/benchmark/results/release/source-consumption-shape-audit.json --md-out packages/benchmark/results/release/source-consumption-shape-audit.md && node packages/benchmark/memory-frontier-audit.mjs --json-out packages/benchmark/results/release/memory-frontier-audit.json --md-out packages/benchmark/results/release/memory-frontier-audit.md && node packages/benchmark/target-distance-audit.mjs --json-out packages/benchmark/results/release/target-distance-audit.json --md-out packages/benchmark/results/release/target-distance-audit.md && node packages/benchmark/text-materialization-boundary-audit.mjs --json-out packages/benchmark/results/release/text-materialization-boundary-audit.json --md-out packages/benchmark/results/release/text-materialization-boundary-audit.md && node packages/benchmark/text-materialization-frontier-coverage-audit.mjs --json-out packages/benchmark/results/release/text-materialization-frontier-coverage-audit.json --md-out packages/benchmark/results/release/text-materialization-frontier-coverage-audit.md && node packages/benchmark/runtime-proof-gap-handoff.mjs --json-out packages/benchmark/results/release/runtime-proof-gap-handoff.json --md-out packages/benchmark/results/release/runtime-proof-gap-handoff.md && node packages/benchmark/runtime-proof-handoff-validation.mjs --json-out packages/benchmark/results/release/runtime-proof-handoff-validation.json --md-out packages/benchmark/results/release/runtime-proof-handoff-validation.md && node packages/benchmark/runtime-limit-proof-obligation-gate.mjs --json-out packages/benchmark/results/release/runtime-limit-proof-obligation-gate.json --md-out packages/benchmark/results/release/runtime-limit-proof-obligation-gate.md',
        },
      ],
      expectedEvidence: [
      ...
      closureChecks: [
        ...
        'runtime-proof-coverage-audit.json coverage.safariWebKitStatus.allAcceptedClosureCasesRecorded must be true for caseId=stringFull|eventObjectFull|rawFrameNameId.',
        'runtime-proof-coverage-audit.json coverage.safariWebKitStatus.allAcceptedLargeBoundedPrimaryClosureCasesRecorded must be true for 1 GiB+ accepted Safari/WebKit primary rows covering caseId=stringFull|eventObjectFull|rawFrameNameId.',
    ...
    handoffs.push({
      ...
      commands: [
        ...
        },
        {
          ...
          command: 'node packages/benchmark/stax-public-reader-host-api-boundary-audit.mjs --json-out packages/benchmark/results/release/stax-public-reader-host-api-boundary-audit.json --md-out packages/benchmark/results/release/stax-public-reader-host-api-boundary-audit.md && node packages/benchmark/spidermonkey-jsshell-tokenizer-headroom.mjs --json-out packages/benchmark/results/release/spidermonkey-jsshell-tokenizer-headroom.json --md-out packages/benchmark/results/release/spidermonkey-jsshell-tokenizer-headroom.md && node packages/benchmark/spidermonkey-jsshell-materialized-headroom.mjs --json-out packages/benchmark/results/release/spidermonkey-jsshell-materialized-headroom.json --md-out packages/benchmark/results/release/spidermonkey-jsshell-materialized-headroom.md && node packages/benchmark/spidermonkey-codegen-closure-audit.mjs --json-out packages/benchmark/results/release/spidermonkey-codegen-closure-audit.json --md-out packages/benchmark/results/release/spidermonkey-codegen-closure-audit.md && node packages/benchmark/spidermonkey-codegen-rerun-stability-audit.mjs --json-out packages/benchmark/results/release/spidermonkey-codegen-rerun-stability-audit.json --md-out packages/benchmark/results/release/spidermonkey-codegen-rerun-stability-audit.md && node packages/benchmark/runtime-counterexample-scan.mjs --json-out packages/benchmark/results/release/runtime-counterexample-scan.json --md-out packages/benchmark/results/release/runtime-counterexample-scan.md && node packages/benchmark/runtime-proof-coverage-audit.mjs --json-out packages/benchmark/results/release/runtime-proof-coverage-audit.json --md-out packages/benchmark/results/release/runtime-proof-coverage-audit.md && node packages/benchmark/source-consumption-shape-audit.mjs --json-out packages/benchmark/results/release/source-consumption-shape-audit.json --md-out packages/benchmark/results/release/source-consumption-shape-audit.md && node packages/benchmark/memory-frontier-audit.mjs --json-out packages/benchmark/results/release/memory-frontier-audit.json --md-out packages/benchmark/results/release/memory-frontier-audit.md && node packages/benchmark/target-distance-audit.mjs --json-out packages/benchmark/results/release/target-distance-audit.json --md-out packages/benchmark/results/release/target-distance-audit.md && node packages/benchmark/text-materialization-boundary-audit.mjs --json-out packages/benchmark/results/release/text-materialization-boundary-audit.json --md-out packages/benchmark/results/release/text-materialization-boundary-audit.md && node packages/benchmark/text-materialization-frontier-coverage-audit.mjs --json-out packages/benchmark/results/release/text-materialization-frontier-coverage-audit.json --md-out packages/benchmark/results/release/text-materialization-frontier-coverage-audit.md && node packages/benchmark/runtime-proof-gap-handoff.mjs --json-out packages/benchmark/results/release/runtime-proof-gap-handoff.json --md-out packages/benchmark/results/release/runtime-proof-gap-handoff.md && node packages/benchmark/runtime-proof-handoff-validation.mjs --json-out packages/benchmark/results/release/runtime-proof-handoff-validation.json --md-out packages/benchmark/results/release/runtime-proof-handoff-validation.md && node packages/benchmark/runtime-limit-proof-obligation-gate.mjs --json-out packages/benchmark/results/release/runtime-limit-proof-obligation-gate.json --md-out packages/benchmark/results/release/runtime-limit-proof-obligation-gate.md',
        },
      ],
      expectedEvidence: [
