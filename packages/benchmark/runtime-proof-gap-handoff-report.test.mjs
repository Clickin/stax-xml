...
test('runtime proof gap handoff tracks current open coverage obligations', () => {
  ...
  assert.ok(spiderMonkey.localClosure.blockers.some(item => /rerun of the current Taskcluster debug js-shell materialized string\/object probe reproduces JitSpew output \(taskId=MUZBnP38TzWA6MfuY9BfzQ, codegenMarkers=234522, throughputMiBPerSec=0\.25\)/.test(item)));
