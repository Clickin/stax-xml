...
test('runtime proof gap handoff tracks current open coverage obligations', () => {
  ...
  assert.ok(spiderMonkey.localClosure.blockers.some(item => /SpiderMonkey codegen closure audit checks 15 diagnostic\/codegen candidates, finds emittedCodegenSurfaceCount=6, sameContractStaxRowCount=0, unchangedRunnableCount=0, selectedRowMetadataCount=0, selectedRowIdentityStatusCounts not-claimed-non-stax-diagnostic=15, qualifiedClosureCount=0, contradictedClosureClaimCount=0, and conclusionAllowed=false/.test(item)));
