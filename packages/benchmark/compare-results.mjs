...
function generateBarChart(value, maxValue, width = 40) {
...
function generateHTMLReport(comparisons, benchmarkData) {
...
async function main() {
    ...
    if (args.length === 0) {
        console.log('Usage: node compare-results.mjs <results-file.json> [--format=console|csv|markdown|html]');
        console.log('\nExample:');
        console.log('  node compare-results.mjs results/inlining-benchmark-2024-01-15.json');
        console.log('  node compare-results.mjs results/inlining-benchmark-2024-01-15.json --format=html');
        process.exit(1);
    }
