...
await assertParserSurfaceParity({ assetPath: ASSET_PATHS.large, xmlString, inputBuffer });
const staxSurfaceRunners = createStaxParserSurfaceRunners({ assetPath: ASSET_PATHS.large, xmlString, inputBuffer });
