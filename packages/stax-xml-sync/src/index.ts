// stax-xml-sync: private workspace package
// Synchronous StAX readers and writer over stax-xml-core.

export { StreamReaderSync } from './StreamReaderSync.js';
export type { StreamReaderSyncInput, StreamReaderSyncOptions } from './StreamReaderSync.js';
