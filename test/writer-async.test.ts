...
import { StaxXmlWriterAsync } from '../src/StaxXmlWriter';
...
async function objectToXmlAsync(obj: any, prettyPrint: boolean = true, indentString: string = '  '): Promise<string> {
  ...
  const writer = new StaxXmlWriterAsync(stream, {
    encoding: 'utf-8',
...
async function writeElementAsync(writer: StaxXmlWriterAsync, element: any): Promise<void> {
...
describe('StaxXmlWriterAsync Basic Functionality Tests', () => {
...
describe('StaxXmlWriterAsync Async-Specific Tests', () => {
  ...
  it('should handle different buffer configurations', async () => {
    ...
    const writer1 = new StaxXmlWriterAsync(stream1, {
      encoding: 'utf-8',
      prettyPrint: false,
      bufferSize: 200,
    ...
    const writer2 = new StaxXmlWriterAsync(stream2, {
      encoding: 'utf-8',
      prettyPrint: false,
      bufferSize: 200,
...
describe('StaxXmlWriterAsync Namespace and Advanced Tests', () => {
...
describe('StaxXmlWriterAsync Error Handling Tests', () => {
...
describe('StaxXmlWriterAsync Performance Tests', () => {
